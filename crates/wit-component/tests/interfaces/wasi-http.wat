(component
  (type (;0;)
    (component
      ...
      (import "wasi:poll/poll" (instance (;0;) (type 0)))
      ...
      (import "wasi:io/streams" (instance (;1;) (type 2)))
      ...
      (export (;2;) "wasi:http/types" (instance (type 5)))
    )
  )
  ...
  (type (;2;)
    (component
      ...
      (import "wasi:http/types" (instance (;2;) (type 5)))
      ...
      (export (;3;) "wasi:http/incoming-handler" (instance (type 8)))
    )
  )
  ...
  (type (;4;)
    (component
      ...
      (export (;3;) "wasi:http/outgoing-handler" (instance (type 9)))
    )
  )
    ...
    (component
      (type (;0;)
        (component
          ...
          (import "wasi:random/random" (instance (;0;) (type 0)))
          (type (;1;)
            (instance
          ...
          (import "wasi:logging/handler" (instance (;1;) (type 1)))
          (type (;2;)
            (instance
              (type (;0;) u32)
              (export (;1;) "pollable" (type (eq 0)))
          ...
          (import "wasi:poll/poll" (instance (;2;) (type 2)))
          ...
          (import "wasi:io/streams" (instance (;3;) (type 4)))
          ...
          (import "wasi:http/types" (instance (;4;) (type 7)))
          ...
          (import "wasi:http/outgoing-handler" (instance (;5;) (type 11)))
          ...
          (export (;6;) "wasi:http/incoming-handler" (instance (type 14)))
        )
      )
      (export (;0;) "wasi:http/proxy" (component (type 0)))
    )
  )
