(component
  (type (;0;)
    (component
      ...
      (import "poll" "path:/poll/poll/poll" (instance (type 0)))
      ...
      (import "streams" "path:/io/streams/streams" (instance (type 2)))
      ...
      (export (;0;) "types" "pkg:/types/types" (instance (type 5)))
    )
  )
  ...
  (type (;2;)
    (component
      ...
      (import "types" "pkg:/types/types" (instance (type 5)))
      ...
      (export (;0;) "outgoing-handler" "pkg:/outgoing-handler/outgoing-handler" (instance (type 9)))
    )
  )
  ...
  (type (;4;)
    (component
      ...
      (export (;0;) "incoming-handler" "pkg:/incoming-handler/incoming-handler" (instance (type 8)))
    )
  )
    ...
    (component
      (type (;0;)
        (component
          ...
          (import "random" "path:/random/random/random" (instance (type 0)))
          (type (;1;)
            (instance
          ...
          (import "console" "path:/logging/handler/handler" (instance (type 1)))
          (type (;2;)
            (instance
              (type (;0;) u32)
              (export (;1;) "pollable" (type (eq 0)))
          ...
          (import "poll" "path:/poll/poll/poll" (instance (type 2)))
          ...
          (import "streams" "path:/io/streams/streams" (instance (type 4)))
          ...
          (import "types" "pkg:/types/types" (instance (type 7)))
          ...
          (import "default-outgoing-HTTP" "pkg:/outgoing-handler/outgoing-handler" (instance (type 11)))
          ...
          (export (;0;) "HTTP" "pkg:/incoming-handler/incoming-handler" (instance (type 14)))
        )
      )
