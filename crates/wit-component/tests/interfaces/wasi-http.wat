(component
  (type (;0;)
    (component
      ...
      (import "poll" "path:/poll/poll/poll" (instance (;0;) (type 0)))
      ...
      (import "streams" "path:/io/streams/streams" (instance (;1;) (type 2)))
      ...
      (export (;2;) "types" "pkg:/types/types" (instance (type 5)))
    )
  )
  ...
  (type (;2;)
    (component
      ...
      (import "types" "pkg:/types/types" (instance (;2;) (type 5)))
      ...
      (export (;3;) "outgoing-handler" "pkg:/outgoing-handler/outgoing-handler" (instance (type 9)))
    )
  )
  (export (;3;) "outgoing-handler" "pkg:/outgoing-handler" (type 2))
  (type (;4;)
    (component
      (type (;0;)
        (instance
      ...
      (export (;3;) "incoming-handler" "pkg:/incoming-handler/incoming-handler" (instance (type 8)))
    )
  )
  (export (;5;) "incoming-handler" "pkg:/incoming-handler" (type 4))
  (type (;6;)
    (component
      (type (;0;)
        (component
          ...
          (import "random" "path:/random/random/random" (instance (;0;) (type 0)))
          (type (;1;)
            (instance
          ...
          (import "console" "path:/logging/handler/handler" (instance (;1;) (type 1)))
          (type (;2;)
            (instance
              (type (;0;) u32)
              (export (;1;) "pollable" (type (eq 0)))
          ...
          (import "poll" "path:/poll/poll/poll" (instance (;2;) (type 2)))
          ...
          (import "streams" "path:/io/streams/streams" (instance (;3;) (type 4)))
          ...
          (import "types" "pkg:/types/types" (instance (;4;) (type 7)))
          ...
          (import "default-outgoing-HTTP" "pkg:/outgoing-handler/outgoing-handler" (instance (;5;) (type 11)))
          ...
          (export (;6;) "HTTP" "pkg:/incoming-handler/incoming-handler" (instance (type 14)))
        )
      )
