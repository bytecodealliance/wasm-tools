    ...
    (component
      (type (;0;)
        (instance
          ...
          (type (;6;) (variant (case "a" s32) (case "b" float32)))
          (export (;7;) "casts1" (type (eq 6)))
          (type (;8;) (variant (case "a" float64) (case "b" float32)))
          (export (;9;) "casts2" (type (eq 8)))
          (type (;10;) (variant (case "a" float64) (case "b" u64)))
