(component
  (type (;0;)
    (component
      ...
      (export (;0;) (interface "variants/variants") (instance (type 0)))
      (type (;1;)
        (component
          (type (;0;)
            (instance
          ...
          (import (interface "variants/variants") (instance (;0;) (type 0)))
        )
      )
      (export (;0;) (interface "variants/variants-world") (component (type 1)))
    )
  )
  (@producers
    (processed-by "wit-component" "$CARGO_PKG_VERSION")
  )
  (export (;1;) (interface "variants/wit") (type 0))
)