(component
  (type (;0;)
    (instance
      ...
      (export "roundtrip-flag1" (func (type 1)))
      (type (;2;) (flags "b0" "b1"))
      (export "flag2" (type (eq 2)))
      (type (;3;) (func (param "x" 2) (result 2)))
      (export "roundtrip-flag2" (func (type 3)))
      (type (;4;) (flags "b0" "b1" "b2" "b3"))
      (export "flag4" (type (eq 4)))
      (type (;5;) (func (param "x" 4) (result 4)))
      (export "roundtrip-flag4" (func (type 5)))
      (type (;6;) (flags "b0" "b1" "b2" "b3" "b4" "b5" "b6" "b7"))
      (export "flag8" (type (eq 6)))
      (type (;7;) (func (param "x" 6) (result 6)))
      (export "roundtrip-flag8" (func (type 7)))
      (type (;8;) (flags "b0" "b1" "b2" "b3" "b4" "b5" "b6" "b7" "b8" "b9" "b10" "b11" "b12" "b13" "b14" "b15"))
      (export "flag16" (type (eq 8)))
      (type (;9;) (func (param "x" 8) (result 8)))
      (export "roundtrip-flag16" (func (type 9)))
      ...
      (export "flag32" (type (eq 10)))
      (type (;11;) (func (param "x" 10) (result 10)))
      (export "roundtrip-flag32" (func (type 11)))
