(component
  (type (;0;)
    (component
      ...
      (import "wasi:io/poll@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;0;) (type 0)))
      ...
      (import "wasi:clocks/monotonic-clock@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;1;) (type 2)))
      (type (;3;)
        (instance
          (export (;0;) "error" (type (sub resource)))
        )
      )
      (import "wasi:io/error@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;2;) (type 3)))
      ...
      (import "wasi:io/streams@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;3;) (type 5)))
      ...
      (export (;4;) "wasi:http/types@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (type 9)))
    )
  )
  ...
  (type (;2;)
    (component
      ...
      (import "wasi:http/types@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (;4;) (type 9)))
      ...
      (export (;5;) "wasi:http/incoming-handler@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (type 12)))
    )
  )
  ...
  (type (;4;)
    (component
      ...
      (export (;5;) "wasi:http/outgoing-handler@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (type 14)))
    )
  )
    ...
    (component
      (type (;0;)
        (component
          ...
          (import "wasi:random/random@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;0;) (type 0)))
          (type (;1;)
            (instance
              (export (;0;) "error" (type (sub resource)))
              (type (;1;) (borrow 0))
          ...
          (import "wasi:io/error@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;1;) (type 1)))
          (type (;2;)
            (instance
              (export (;0;) "pollable" (type (sub resource)))
              (type (;1;) (borrow 0))
          ...
          (import "wasi:io/poll@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;2;) (type 2)))
          ...
          (import "wasi:cli/stdout@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (;4;) (type 7)))
          (type (;8;)
            (instance
              (alias outer 1 6 (type (;0;)))
              (export (;1;) "output-stream" (type (eq 0)))
          ...
          (import "wasi:cli/stderr@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (;5;) (type 8)))
          ...
          (import "wasi:cli/stdin@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (;6;) (type 10)))
          (type (;11;)
            (instance
              (alias outer 1 4 (type (;0;)))
              (export (;1;) "pollable" (type (eq 0)))
          ...
          (import "wasi:clocks/monotonic-clock@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;7;) (type 11)))
          ...
          (import "wasi:http/types@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (;8;) (type 13)))
          ...
          (import "wasi:http/outgoing-handler@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (;9;) (type 18)))
          (type (;19;)
            (instance
          ...
          (import "wasi:clocks/wall-clock@0.2" (versionsuffix ".0-rc-2023-11-10") (instance (;10;) (type 19)))
          ...
          (export (;11;) "wasi:http/incoming-handler@0.2" (versionsuffix ".0-rc-2023-12-05") (instance (type 22)))
        )
      )
