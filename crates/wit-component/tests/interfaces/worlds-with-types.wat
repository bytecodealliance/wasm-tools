(component
  (type (;0;)
    (component
      ...
      (export (;0;) (interface "foo/import-me") (instance (type 0)))
      (type (;1;)
        (component
          (type (;0;) (record))
      ...
      (export (;0;) (interface "foo/simple") (component (type 1)))
      (type (;2;)
        (component
          (type (;0;)
            (instance
          ...
          (import (interface "foo/import-me") (instance (;0;) (type 0)))
      ...
      (export (;1;) (interface "foo/with-imports") (component (type 2)))
    )
  )
  (@producers
