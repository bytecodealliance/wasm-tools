(component
  ...
  (type (;18;) (record))
  (type (;19;) (record (field "a" u32) (field "b" u32)))
  (type (;20;) (flags "a" "b" "c" "d" "e" "f" "g" "h" "i"))
  (type (;21;) (record (field "a" 19) (field "b" u32) (field "c" 18) (field "d" string) (field "e" 20)))
  (type (;22;) s32)
  (type (;23;) (tuple 22))
  (type (;24;) (func (param "x" 18)))
  (type (;25;) (func (result 18)))
  (type (;26;) (func (param "x" 19)))
  (type (;27;) (func (result 19)))
  (type (;28;) (func (param "x" 20)))
  (type (;29;) (func (result 20)))
  (type (;30;) (func (param "x" 21)))
  (type (;31;) (func (result 21)))
  (type (;32;) (func (param "e" 23) (result s32)))
  (type (;33;)
    (instance
      (alias outer 1 18 (type (;0;)))
      (export "empty" (type (eq 0)))
      (alias outer 1 19 (type (;1;)))
      (export "scalars" (type (eq 1)))
      (alias outer 1 20 (type (;2;)))
      (export "really-flags" (type (eq 2)))
      (alias outer 1 21 (type (;3;)))
      (export "aggregates" (type (eq 3)))
      (alias outer 1 22 (type (;4;)))
      (export "int-typedef" (type (eq 4)))
      (alias outer 1 23 (type (;5;)))
  ...
  (import "records" (instance (;0;) (type 33)))
  (export "records" (type 35))
)