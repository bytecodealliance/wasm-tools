(component
  (type (;0;)
    (component
      ...
      (export (;0;) (interface "flags/imports") (instance (type 0)))
      (type (;1;)
        (component
          (type (;0;)
            (instance
          ...
          (import (interface "flags/imports") (instance (;0;) (type 0)))
        )
      )
      (export (;0;) (interface "flags/flags-world") (component (type 1)))
    )
  )
  (@producers
    (processed-by "wit-component" "$CARGO_PKG_VERSION")
  )
  (export (;1;) (interface "flags/wit") (type 0))
)