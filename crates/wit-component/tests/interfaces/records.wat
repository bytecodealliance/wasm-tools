(component
  (type (;0;)
    (component
      ...
      (export (;0;) (interface "records/records") (instance (type 0)))
      (type (;1;)
        (component
          (type (;0;)
            (instance
          ...
          (import (interface "records/records") (instance (;0;) (type 0)))
          (type (;1;)
            (instance
              (type (;0;) (record (field "a" u32) (field "b" u32)))
              (export (;1;) "scalars" (type (eq 0)))
          ...
          (export (;1;) (interface "records/records") (instance (type 1)))
        )
      )
      (export (;0;) (interface "records/records-world") (component (type 1)))
    )
  )
  (@producers
    (processed-by "wit-component" "$CARGO_PKG_VERSION")
  )
  (export (;1;) (interface "records/wit") (type 0))
)