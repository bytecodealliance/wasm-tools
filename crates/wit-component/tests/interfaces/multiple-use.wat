(component
  (type (;0;)
    (component
      ...
      (export (;0;) (interface "multiuse/foo") (instance (type 0)))
      (type (;1;)
        (instance
          (type (;0;) u8)
      ...
      (export (;1;) (interface "multiuse/bar") (instance (type 1)))
      ...
      (export (;2;) (interface "multiuse/baz") (instance (type 5)))
    )
  )
  (@producers
    (processed-by "wit-component" "$CARGO_PKG_VERSION")
  )
  (export (;1;) (interface "multiuse/wit") (type 0))
)