(component
  ...
  (type (;4;)
    (component
      ...
      (export (;0;) (interface "foo:bar/implicit-own-handles") (instance (type 0)))
    )
  )
  ...
  (type (;6;)
    (component
      ...
      (export (;0;) (interface "foo:bar/implicit-own-handles2") (instance (type 0)))
    )
  )
  ...
  (type (;8;)
    (component
      ...
      (export (;0;) (interface "foo:bar/some-world") (component (type 0)))
    )
  )
  ...
  (type (;10;)
    (component
      ...
      (export (;0;) (interface "foo:bar/implicit-own-handles3") (component (type 0)))
    )
  )
