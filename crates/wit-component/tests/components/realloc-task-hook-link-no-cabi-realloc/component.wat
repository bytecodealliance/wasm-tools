(component
  ...
  (core module $main (;0;)
    ...
    (import "c" "cabi_realloc" (func (;0;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (table (;0;) 2 funcref)
    (memory (;0;) 17)
  ...
  (core module $foo (;2;)
    ...
    (import "test:test/test" "bar" (func $bar (;0;) (type 0) (param i32 i32 i32)))
    (export "run" (func 1))
    (export "greet" (func 2))
  ...
  (core module $wit-component-fixup (;4;)
    ...
    (import "c" "__wasm_task_hook" (func $__wasm_task_hook (;3;) (type 3) (param i32)))
    (import "main" "__wasm_task_hook" (func $"#func4 __wasm_task_hook" (@name "__wasm_task_hook") (;4;) (type 3) (param i32)))
    (import "foo" "run" (func $run (;5;) (type 4) (result i32)))
    (import "foo" "greet" (func $greet (;6;) (type 5) (param i32 i32) (result i32)))
    (import "foo" "cabi_post_greet" (func $cabi_post_greet (;7;) (type 3) (param i32)))
    (import "main" "cabi_realloc" (func $cabi_realloc (;8;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (import "c" "cabi_realloc" (func $"#func9 cabi_realloc" (@name "cabi_realloc") (;9;) (type 0) (param i32 i32 i32 i32) (result i32)))
