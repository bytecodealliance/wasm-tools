(component
  ...
  (core module (;1;)
    ...
    (export "7" (func $"indirect-foo:foo/bar-[async]foo"))
    ...
    (func $"indirect-foo:foo/bar-[async]foo" (;7;) (type 0) (param i32 i32) (result i32)
      local.get 0
      local.get 1
      i32.const 7
      call_indirect (type 0)
  ...
  (alias core export 5 "[async-stackful]foo" (core func (;113;)))
  (func (;2;) (type 4) (canon lift (core func 113) async))
  (export (;3;) "foo" (func 2))
  (type (;14;) (func (param "x" 13) (param "y" u32) (result 11)))
  (alias core export 5 "[async-stackful]foo:foo/bar#foo" (core func (;114;)))
