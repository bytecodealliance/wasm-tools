(component
  ...
  (func $"#func2 foo" (@name "foo") (;2;) (type 4) (canon lift (core func $"[async-lift-stackful]foo") (memory $memory) string-encoding=utf8 async))
  ...
  (func $"#func4 foo" (@name "foo") (;4;) (type 9) (canon lift (core func $"[async-lift-stackful]foo:foo/bar#foo") (memory $memory) string-encoding=utf8 async))
