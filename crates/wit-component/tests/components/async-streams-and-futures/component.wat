(component
  ...
  (core module (;0;)
    ...
    (import "$root" "[stream-close-readable-2]foo" (func (;7;) (type 1)))
    (import "$root" "[stream-close-writable-2]foo" (func (;8;) (type 1)))
    ...
    (import "foo:foo/bar" "[stream-close-readable-2]foo" (func (;14;) (type 1)))
    (import "foo:foo/bar" "[stream-close-writable-2]foo" (func (;15;) (type 1)))
    ...
    (import "$root" "[future-close-readable-0]foo" (func (;21;) (type 1)))
    (import "$root" "[future-close-writable-0]foo" (func (;22;) (type 1)))
    ...
    (import "foo:foo/bar" "[future-close-readable-0]foo" (func (;28;) (type 1)))
    (import "foo:foo/bar" "[future-close-writable-0]foo" (func (;29;) (type 1)))
    ...
    (import "$root" "[future-close-readable-1]foo" (func (;35;) (type 1)))
    (import "$root" "[future-close-writable-1]foo" (func (;36;) (type 1)))
    ...
    (import "foo:foo/bar" "[future-close-readable-1]foo" (func (;42;) (type 1)))
    (import "foo:foo/bar" "[future-close-writable-1]foo" (func (;43;) (type 1)))
    ...
    (import "[export]$root" "[stream-close-readable-2]foo" (func (;49;) (type 1)))
    (import "[export]$root" "[stream-close-writable-2]foo" (func (;50;) (type 1)))
    ...
    (import "[export]foo:foo/bar" "[stream-close-readable-2]foo" (func (;56;) (type 1)))
    (import "[export]foo:foo/bar" "[stream-close-writable-2]foo" (func (;57;) (type 1)))
    ...
    (import "[export]$root" "[future-close-readable-0]foo" (func (;63;) (type 1)))
    (import "[export]$root" "[future-close-writable-0]foo" (func (;64;) (type 1)))
    ...
    (import "[export]foo:foo/bar" "[future-close-readable-0]foo" (func (;70;) (type 1)))
    (import "[export]foo:foo/bar" "[future-close-writable-0]foo" (func (;71;) (type 1)))
    ...
    (import "[export]$root" "[future-close-readable-1]foo" (func (;77;) (type 1)))
    (import "[export]$root" "[future-close-writable-1]foo" (func (;78;) (type 1)))
    ...
    (import "[export]foo:foo/bar" "[future-close-readable-1]foo" (func (;84;) (type 1)))
    (import "[export]foo:foo/bar" "[future-close-writable-1]foo" (func (;85;) (type 1)))
    (memory (;0;) 1)
