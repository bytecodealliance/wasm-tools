(module
  ...
  (func (import "$root" "[stream-new-2]foo") (param i32))
  ...
  (func (import "$root" "[stream-close-writable-2]foo") (param i32))
  (func (import "foo:foo/bar" "[stream-new-2]foo") (param i32))
  ...
  (func (import "foo:foo/bar" "[stream-close-writable-2]foo") (param i32))
  (func (import "$root" "[future-new-0]foo") (param i32))
  ...
  (func (import "$root" "[future-close-writable-0]foo") (param i32))
  (func (import "foo:foo/bar" "[future-new-0]foo") (param i32))
  ...
  (func (import "foo:foo/bar" "[future-close-writable-0]foo") (param i32))
  (func (import "$root" "[future-new-1]foo") (param i32))
  ...
  (func (import "$root" "[future-close-writable-1]foo") (param i32))
  (func (import "foo:foo/bar" "[future-new-1]foo") (param i32))
  ...
  (func (import "foo:foo/bar" "[future-close-writable-1]foo") (param i32))
  (func (import "[export]$root" "[stream-new-2]foo") (param i32))
  ...
  (func (import "[export]$root" "[stream-close-writable-2]foo") (param i32))
  (func (import "[export]foo:foo/bar" "[stream-new-2]foo") (param i32))
  ...
  (func (import "[export]foo:foo/bar" "[stream-close-writable-2]foo") (param i32))
  (func (import "[export]$root" "[future-new-0]foo") (param i32))
  ...
  (func (import "[export]$root" "[future-close-writable-0]foo") (param i32))
  (func (import "[export]foo:foo/bar" "[future-new-0]foo") (param i32))
  ...
  (func (import "[export]foo:foo/bar" "[future-close-writable-0]foo") (param i32))
  (func (import "[export]$root" "[future-new-1]foo") (param i32))
  ...
  (func (import "[export]$root" "[future-close-writable-1]foo") (param i32))
  (func (import "[export]foo:foo/bar" "[future-new-1]foo") (param i32))
  ...
  (func (import "[export]foo:foo/bar" "[future-close-writable-1]foo") (param i32))
