(component
  ...
  (core module $main (;0;)
    ...
    (import "wasi-snapshot-preview1" "proc_exit" (func $exit1 (;0;) (type 0) (param i32)))
    (import "wasi-snapshot-preview1" "proc_exit [v2]" (func $exit2 (;1;) (type 0) (param i32)))
    (import "cm32p2" "f" (func $f_v1 (;2;) (type 1)))
    (import "cm32p2" "f2" (func $f2 (;3;) (type 2) (result i32)))
    ...
    (import "cm32p2" "g2" (func $g2 (;8;) (type 2) (result i32)))
    (memory (;0;) 1)
  ...
  (core module $wit-component:adapter:wasi-snapshot-preview1 (;1;)
    (type (;0;) (func (param i32)))
    (import "foo:foo/my-wasi" "proc-exit" (func $proc_exit (;0;) (type 0) (param i32)))
