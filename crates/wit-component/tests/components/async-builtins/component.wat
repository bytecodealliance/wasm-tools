(component
  ...
  (core module (;1;)
    ...
    (func $task-return-foo (;4;) (type 3) (param i32 i32)
      local.get 0
      local.get 1
      i32.const 4
  ...
  (core func (;9;) (canon task.wait (memory 0)))
  (core func (;10;) (canon task.poll (memory 0)))
  (core func (;11;) (canon error-context.new (memory 0) string-encoding=utf8))
  (alias core export 4 "cabi_realloc" (core func (;12;)))
  (core func (;13;) (canon error-context.debug-message (memory 0) (realloc 12) string-encoding=utf8))
  (core func (;14;) (canon task.return (result string) (memory 0) string-encoding=utf8))
  (core instance (;5;)
    (export "$imports" (table 0))
    (export "0" (func 9))
    (export "1" (func 10))
  ...
  (func (;0;) (type 0) (canon lift (core func 15) (memory 0) (realloc 12) string-encoding=utf8 async))
  (export (;1;) "foo" (func 0))
  (type (;1;) (func (param "s" string) (result string)))
  (alias core export 4 "[async-stackful]foo:foo/bar#foo" (core func (;16;)))
  (func (;2;) (type 1) (canon lift (core func 16) (memory 0) (realloc 12) string-encoding=utf8 async))
  (component (;0;)
    (type (;0;) (func (param "s" string) (result string)))
