(component
  (core module (;0;)
    ...
    (memory (;0;) 1)
    (export "[async]foo" (func 10))
    (export "[async]foo:foo/bar#foo" (func 11))
  ...
  (alias core export 3 "[async]foo" (core func (;15;)))
  ...
  (alias core export 3 "[async]foo:foo/bar#foo" (core func (;16;)))
