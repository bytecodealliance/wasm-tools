(component
  (core module (;0;)
    ...
    (import "$root" "[context-get-0]" (func (;17;) (type 2)))
    (import "$root" "[context-get-1]" (func (;18;) (type 2)))
    (import "$root" "[context-set-0]" (func (;19;) (type 0)))
    (import "$root" "[context-set-1]" (func (;20;) (type 0)))
    (memory (;0;) 1)
  ...
  (core func (;15;) (canon context.get i32 0))
  (core func (;16;) (canon context.get i32 1))
  (core func (;17;) (canon context.set i32 0))
  (core func (;18;) (canon context.set i32 1))
  (core instance (;1;)
    ...
    (export "[context-get-0]" (func 15))
    (export "[context-get-1]" (func 16))
    (export "[context-set-0]" (func 17))
    (export "[context-set-1]" (func 18))
  )
