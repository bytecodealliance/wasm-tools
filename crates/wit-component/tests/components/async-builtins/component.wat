(component
  (core module (;0;)
    ...
    (import "$root" "[subtask-cancel]" (func (;10;) (type 5)))
    (import "$root" "[error-context-new-utf8]" (func (;11;) (type 3)))
    (import "$root" "[error-context-new-utf16]" (func (;12;) (type 3)))
    (import "$root" "[error-context-new-latin1+utf16]" (func (;13;) (type 3)))
    (import "$root" "[error-context-debug-message-utf8]" (func (;14;) (type 1)))
    (import "$root" "[error-context-debug-message-utf16]" (func (;15;) (type 1)))
    (import "$root" "[error-context-debug-message-latin1+utf16]" (func (;16;) (type 1)))
    (import "$root" "[error-context-drop]" (func (;17;) (type 0)))
    (import "$root" "[context-get-0]" (func (;18;) (type 2)))
    (import "$root" "[context-get-1]" (func (;19;) (type 2)))
    (import "$root" "[context-set-0]" (func (;20;) (type 0)))
    (import "$root" "[context-set-1]" (func (;21;) (type 0)))
    (memory (;0;) 1)
  ...
  (alias core export 0 "8" (core func (;20;)))
  (core instance (;2;)
    (export "[task-return]foo" (func 20))
  )
  (alias core export 0 "9" (core func (;21;)))
  (core instance (;3;)
  ...
  (core func (;22;) (canon waitable-set.wait (memory 0)))
  (core func (;23;) (canon waitable-set.poll (memory 0)))
  (core func (;24;) (canon error-context.new (memory 0) string-encoding=utf8))
  (core func (;25;) (canon error-context.new (memory 0) string-encoding=utf16))
  (core func (;26;) (canon error-context.new (memory 0) string-encoding=latin1+utf16))
  (alias core export 4 "cabi_realloc" (core func (;27;)))
  (core func (;28;) (canon error-context.debug-message (memory 0) (realloc 27) string-encoding=utf8))
  (core func (;29;) (canon error-context.debug-message (memory 0) (realloc 27) string-encoding=utf16))
  (core func (;30;) (canon error-context.debug-message (memory 0) (realloc 27) string-encoding=latin1+utf16))
  ...
  (alias core export 4 "[async-lift-stackful]foo" (core func (;33;)))
  (func (;0;) (type 0) (canon lift (core func 33) (memory 0) (realloc 27) string-encoding=utf8 async))
  (export (;1;) "foo" (func 0))
  (type (;1;) (func (param "s" string) (result string)))
  (alias core export 4 "[async-lift-stackful]foo:foo/bar#foo" (core func (;34;)))
  (func (;2;) (type 1) (canon lift (core func 34) (memory 0) (realloc 27) string-encoding=utf8 async))
  (component (;0;)
    (type (;0;) (func (param "s" string) (result string)))
