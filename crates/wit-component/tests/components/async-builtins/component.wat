(component
  ...
  (core func (;1;) (canon backpressure.inc))
  (core func (;2;) (canon backpressure.dec))
  (core func (;3;) (canon waitable-set.new))
  (alias core export 0 "0" (core func (;4;)))
  (alias core export 0 "1" (core func (;5;)))
  (core func (;6;) (canon waitable-set.drop))
  (core func (;7;) (canon waitable.join))
  (core func (;8;) (canon thread.yield))
  (core func (;9;) (canon subtask.drop))
  (core func (;10;) (canon subtask.cancel))
  (alias core export 0 "2" (core func (;11;)))
  (alias core export 0 "3" (core func (;12;)))
  (alias core export 0 "4" (core func (;13;)))
  (alias core export 0 "5" (core func (;14;)))
  (alias core export 0 "6" (core func (;15;)))
  (alias core export 0 "7" (core func (;16;)))
  (core func (;17;) (canon error-context.drop))
  (core func (;18;) (canon context.get i32 0))
  (core func (;19;) (canon context.set i32 0))
  (core instance (;1;)
    (export "[backpressure-set]" (func 0))
    (export "[backpressure-inc]" (func 1))
    (export "[backpressure-dec]" (func 2))
    (export "[waitable-set-new]" (func 3))
    (export "[waitable-set-wait]" (func 4))
    (export "[waitable-set-poll]" (func 5))
    (export "[waitable-set-drop]" (func 6))
    (export "[waitable-join]" (func 7))
    (export "[thread-yield]" (func 8))
    (export "[subtask-drop]" (func 9))
    (export "[subtask-cancel]" (func 10))
    (export "[error-context-new-utf8]" (func 11))
    (export "[error-context-new-utf16]" (func 12))
    (export "[error-context-new-latin1+utf16]" (func 13))
    (export "[error-context-debug-message-utf8]" (func 14))
    (export "[error-context-debug-message-utf16]" (func 15))
    (export "[error-context-debug-message-latin1+utf16]" (func 16))
    (export "[error-context-drop]" (func 17))
    (export "[context-get-0]" (func 18))
    (export "[context-set-0]" (func 19))
  )
