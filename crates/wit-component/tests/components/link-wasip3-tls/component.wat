(component
  (core module $main (;0;)
    ...
    (import "$root" "[context-get-1]" (func (;0;) (type 0) (result i32)))
    (table (;0;) 1 funcref)
    (memory (;0;) 17)
  ...
  (core module $c (;1;)
    ...
    (import "env" "__wasm_get_stack_pointer" (func $get_sp (;0;) (type $get) (result i32)))
    (import "env" "__wasm_set_stack_pointer" (func $set_sp (;1;) (type $set) (param i32)))
    (import "env" "__wasm_get_tls_base" (func $get_tls (;2;) (type $get) (result i32)))
    (import "env" "__wasm_set_tls_base" (func $set_tls (;3;) (type $set) (param i32)))
    (import "$root" "[context-get-1]" (func $get_ctx (;4;) (type $get) (result i32)))
    (import "$root" "[context-set-1]" (func $set_ctx (;5;) (type $set) (param i32)))
    (import "GOT.mem" "__wasm_program_tls_info" (global $tls_info (;2;) (mut i32)))
    (import "$root" "[thread-new-indirect-v0]" (func $spawn (;6;) (type $spawn) (param i32 i32) (result i32)))
  ...
  (core module $foo (;3;)
    ...
    (import "env" "__memory_base" (global $__memory_base (;0;) i32))
    (import "env" "__table_base" (global $__table_base (;1;) i32))
    (import "env" "__wasm_get_tls_base" (func $get_tls (;0;) (type $get) (result i32)))
    (import "env" "__wasm_set_tls_base" (func $set_tls (;1;) (type $set) (param i32)))
    (import "env" "abort" (func $abort (;2;) (type $void)))
    (import "env" "none_helper" (func $none_helper (;3;) (type $get) (result i32)))
