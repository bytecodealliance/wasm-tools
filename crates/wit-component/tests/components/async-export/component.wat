(component
  (core module (;0;)
    ...
    (memory (;0;) 1)
    (export "[async-stackful]foo" (func 0))
    (export "[async-stackful]foo:foo/bar#foo" (func 1))
  ...
  (alias core export 0 "[async-stackful]foo" (core func (;0;)))
  ...
  (alias core export 0 "[async-stackful]foo:foo/bar#foo" (core func (;2;)))
