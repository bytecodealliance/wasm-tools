(component
  ...
  (alias core export $main "_initialize" (core func $start (;14;)))
  (core module $start-shim-module (;2;)
    (type (;0;) (func))
  ...
  (core instance $start-shim-args (;3;)
    (export "" (func $start))
    (export "init" (func $__wasm_init_task))
  )
  (core instance $start-shim-instance (;4;) (instantiate $start-shim-module
      (with "" (instance $start-shim-args))
    )
  )
  (type (;0;) (func async))
  (alias core export $main "cabi_realloc" (core func $cabi_realloc (;15;)))
  ...
  (alias core export $main "[callback][async-lift]async-callback" (core func $"[callback][async-lift]async-callback" (;16;)))
  ...
  (alias core export $main "[callback][async-lift]async-callback-argret" (core func $"[callback][async-lift]async-callback-argret" (;17;)))
