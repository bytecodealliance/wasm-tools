(component
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "main" "__wasm_task_hook" (func $__wasm_task_hook (;2;) (type 0) (param i32)))
    (import "main" "[async-lift-stackful]async-stackful" (func $"[async-lift-stackful]async-stackful" (;3;) (type 1)))
    (import "main" "[async-lift]async-callback" (func $"[async-lift]async-callback" (;4;) (type 2) (result i32)))
    (import "main" "[callback][async-lift]async-callback" (func $"[callback][async-lift]async-callback" (;5;) (type 3) (param i32 i32 i32) (result i32)))
    (import "main" "sync" (func $sync (;6;) (type 1)))
    (import "main" "cabi_post_sync" (func $cabi_post_sync (;7;) (type 1)))
    (import "main" "[async-lift-stackful]async-stackful-argret" (func $"[async-lift-stackful]async-stackful-argret" (;8;) (type 4) (param i32 i32)))
    (import "main" "[async-lift]async-callback-argret" (func $"[async-lift]async-callback-argret" (;9;) (type 5) (param i32 i32) (result i32)))
    (import "main" "[callback][async-lift]async-callback-argret" (func $"[callback][async-lift]async-callback-argret" (;10;) (type 3) (param i32 i32 i32) (result i32)))
    (import "main" "sync-argret" (func $sync-argret (;11;) (type 5) (param i32 i32) (result i32)))
    (import "main" "x#sync" (func $x#sync (;12;) (type 1)))
    (import "main" "cabi_realloc" (func $cabi_realloc (;13;) (type 6) (param i32 i32 i32 i32) (result i32)))
