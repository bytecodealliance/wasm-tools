(component
  ...
  (type (;1;) (func))
  (func $sync (;4;) (type 1) (canon lift (core func $"#core-func10 sync")))
  (export $"#func5 sync" (@name "sync") (;5;) "sync" (func $sync))
  (type (;2;) (func async (param "s" string) (result string)))
  (func $async-stackful-argret (;6;) (type 2) (canon lift (core func $"#core-func11 [async-lift-stackful]async-stackful-argret") (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 async))
  ...
  (func $async-callback-argret (;8;) (type 2) (canon lift (core func $"#core-func12 [async-lift]async-callback-argret") (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 async (callback $"[callback][async-lift]async-callback-argret")))
  ...
  (func $sync-argret (;10;) (type 3) (canon lift (core func $"#core-func13 sync-argret") (memory $memory) (realloc $cabi_realloc) string-encoding=utf8))
