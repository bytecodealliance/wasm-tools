(component
  ...
  (core module $foo (;1;)
    ...
    (import "env" "cabi_realloc" (func $cabi_realloc.0 (;0;) (type 0) (param i32 i32 i32 i32) (result i32)))
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "foo" "cabi_realloc" (func $cabi_realloc (;0;) (type 1) (param i32 i32 i32 i32) (result i32)))
    (import "foo" "__wasm_task_hook" (func $__wasm_task_hook (;1;) (type 2) (param i32)))
    (import "main" "__wasm_task_hook" (func $"#func2 __wasm_task_hook" (@name "__wasm_task_hook") (;2;) (type 2) (param i32)))
    (import "foo" "test:test/test#foo" (func $test:test/test#foo (;3;) (type 3) (param i32 i32)))
    (import "main" "cabi_realloc" (func $"#func4 cabi_realloc" (@name "cabi_realloc") (;4;) (type 1) (param i32 i32 i32 i32) (result i32)))
