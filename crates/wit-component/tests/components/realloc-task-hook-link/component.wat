(component
  ...
  (core module $main (;0;)
    ...
    (import "foo" "cabi_realloc" (func (;0;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (table (;0;) 2 funcref)
    (memory (;0;) 17)
  ...
  (core module $wit-component-fixup (;4;)
    ...
    (import "actual" "0" (func $0 (;0;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (import "actual" "1" (func $1 (;1;) (type 1) (param i32)))
    (import "actual" "2" (func $2 (;2;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (import "main" "memory" (memory (;0;) 0))
    (import "main" "__indirect_function_table" (table (;0;) 0 funcref))
    (import "c" "__wasm_task_hook" (func $__wasm_task_hook (;3;) (type 1) (param i32)))
    (import "main" "__wasm_task_hook" (func $"#func4 __wasm_task_hook" (@name "__wasm_task_hook") (;4;) (type 1) (param i32)))
    (import "foo" "baz" (func $baz (;5;) (type 2)))
    (import "foo" "foo2" (func $foo2 (;6;) (type 3) (param i32 i32) (result i32)))
    (import "foo" "cabi_post_foo2" (func $cabi_post_foo2 (;7;) (type 1) (param i32)))
    (import "main" "cabi_realloc" (func $cabi_realloc (;8;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (import "foo" "cabi_realloc" (func $"#func9 cabi_realloc" (@name "cabi_realloc") (;9;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (import "foo" "cabi_import_realloc" (func $cabi_import_realloc (;10;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (import "foo" "cabi_export_realloc" (func $cabi_export_realloc (;11;) (type 0) (param i32 i32 i32 i32) (result i32)))
