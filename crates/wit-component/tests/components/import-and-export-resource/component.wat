(component
  ...
  (core module $main (;0;)
    ...
    (import "foo:bar/foo" "[resource-drop]a" (func (;0;) (type 0) (param i32)))
    (import "[export]foo:bar/foo" "[resource-drop]a" (func (;1;) (type 0) (param i32)))
    (import "[export]foo:bar/foo" "[resource-rep]a" (func (;2;) (type 1) (param i32) (result i32)))
    (import "[export]foo:bar/foo" "[resource-new]a" (func (;3;) (type 1) (param i32) (result i32)))
    (@producers
