(component
  ...
  (core module $main (;0;)
    ...
    (import "foo:shared-dependency/doc" "g1" (func (;2;) (type 1) (param i32)))
    (import "foo:shared-dependency/doc" "g2" (func (;3;) (type 1) (param i32)))
    (import "old" "adapter-f1" (func (;4;) (type 0)))
    (import "main-dep" "foo" (func (;5;) (type 2) (result i32)))
    (memory (;0;) 1)
  ...
  (core module $wit-component:adapter:old (;1;)
    ...
    (import "foo:shared-dependency/doc" "g1" (func $g1 (;2;) (type 1) (param i32)))
    (import "foo:shared-dependency/doc" "g3" (func $g3 (;3;) (type 1) (param i32)))
    (import "adapter-dep" "foo" (func $foo (;4;) (type 2) (result i32)))
  ...
  (core module $wit-component-fixup (;3;)
    ...
    (import "actual" "1" (func $1 (;1;) (type 0) (param i32)))
    (import "actual" "2" (func $2 (;2;) (type 1)))
    (import "actual" "3" (func $3 (;3;) (type 0) (param i32)))
    (import "actual" "4" (func $4 (;4;) (type 0) (param i32)))
  ...
  (alias core export $main "cabi_realloc" (core func $cabi_realloc (;11;)))
  (core func $"#core-func12 indirect-foo:shared-dependency/doc-g1" (@name "indirect-foo:shared-dependency/doc-g1") (;12;) (canon lower (func $g1) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8))
  (alias export $foo:shared-dependency/doc "g2" (func $g2 (;7;)))
  (core func $"#core-func13 indirect-foo:shared-dependency/doc-g2" (@name "indirect-foo:shared-dependency/doc-g2") (;13;) (canon lower (func $g2) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8))
  ...
  (alias core export $"#core-instance7 old" "cabi_import_realloc" (core func $cabi_import_realloc (;15;)))
  (core func $"#core-func16 indirect-foo:shared-dependency/doc-g1" (@name "indirect-foo:shared-dependency/doc-g1") (;16;) (canon lower (func $"#func8 g1") (memory $memory) (realloc $cabi_import_realloc) string-encoding=utf8))
  (alias export $foo:shared-dependency/doc "g3" (func $g3 (;9;)))
  (core func $"#core-func17 indirect-foo:shared-dependency/doc-g3" (@name "indirect-foo:shared-dependency/doc-g3") (;17;) (canon lower (func $g3) (memory $memory) (realloc $cabi_import_realloc) string-encoding=utf8))
