(component
  ...
  (core module $bar (;1;)
    ...
    (type (;0;) (func (param i32) (result i32)))
    (import "env" "foo" (func $import_foo (;0;) (type 0) (param i32) (result i32)))
    (export "bar" (func $bar))
  ...
  (alias core export $bar "bar" (core func $bar (;2;)))
  ...
  (core module $wit-component-fixup (;3;)
    ...
    (import "foo" "foo" (func $foo (;0;) (type 1) (param i32) (result i32)))
