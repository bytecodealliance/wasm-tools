(component
  (core module (;0;)
    ...
    (import "[export]foo" "[resource-drop-borrow]a" (func (;2;) (type 1)))
    (import "[export]foo" "[resource-drop-own]a" (func (;3;) (type 1)))
    ...
    (export "foo#[constructor]a" (func 4))
    (export "foo#[static]a.other-new" (func 5))
    (export "foo#[dtor]a" (func 6))
    (@producers
  ...
  (type (;2;) (borrow 0))
  (core func (;2;) (canon resource.drop 2))
  (core func (;3;) (canon resource.rep 0))
  (core func (;4;) (canon resource.new 0))
  (core instance (;1;)
    (export "[resource-drop-own]a" (func 1))
    (export "[resource-drop-borrow]a" (func 2))
    (export "[resource-rep]a" (func 3))
    (export "[resource-new]a" (func 4))
  )
  ...
  (alias core export 2 "foo#[dtor]a" (core func (;5;)))
  (core instance (;3;)
    (export "$imports" (table 0))
    (export "0" (func 5))
  )
  ...
  (alias core export 2 "foo#[constructor]a" (core func (;6;)))
  (func (;0;) (type 4) (canon lift (core func 6)))
  (alias core export 2 "foo#[static]a.other-new" (core func (;7;)))
