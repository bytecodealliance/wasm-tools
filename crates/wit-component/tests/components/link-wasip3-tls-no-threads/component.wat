(component
  ...
  (core module $c (;1;)
    ...
    (import "env" "__wasm_get_stack_pointer" (func (;0;) (type 0) (result i32)))
    (import "env" "__wasm_set_stack_pointer" (func (;1;) (type 1) (param i32)))
    (import "env" "__wasm_get_tls_base" (func (;2;) (type 0) (result i32)))
    (import "env" "__wasm_set_tls_base" (func (;3;) (type 1) (param i32)))
  ...
  (core module $foo (;2;)
    ...
    (import "env" "__wasm_get_stack_pointer" (func (;0;) (type 0) (result i32)))
    (import "env" "__wasm_set_stack_pointer" (func (;1;) (type 1) (param i32)))
    (import "env" "__wasm_get_tls_base" (func $get_tls (;2;) (type 0) (result i32)))
    (import "env" "__wasm_set_tls_base" (func (;3;) (type 1) (param i32)))
