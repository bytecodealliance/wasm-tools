(component
  (core module $main (;0;)
    ...
    (import "[export]$root" "[task-return]foo" (func (;3;) (type 1) (param i32 i32)))
    (import "[export]foo:foo/bar" "[task-return]foo" (func (;4;) (type 1) (param i32 i32)))
    (import "$root" "[waitable-set-new]" (func (;5;) (type 2) (result i32)))
    (import "$root" "[waitable-set-wait]" (func (;6;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[waitable-set-poll]" (func (;7;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[waitable-set-drop]" (func (;8;) (type 4) (param i32)))
    (import "$root" "[waitable-join]" (func (;9;) (type 1) (param i32 i32)))
    (import "$root" "[thread-yield]" (func (;10;) (type 2) (result i32)))
    (import "$root" "[subtask-drop]" (func (;11;) (type 4) (param i32)))
    (import "$root" "[subtask-cancel]" (func (;12;) (type 5) (param i32) (result i32)))
    (import "$root" "[error-context-new-utf8]" (func (;13;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[error-context-new-utf16]" (func (;14;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[error-context-new-latin1+utf16]" (func (;15;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[error-context-debug-message-utf8]" (func (;16;) (type 1) (param i32 i32)))
    (import "$root" "[error-context-debug-message-utf16]" (func (;17;) (type 1) (param i32 i32)))
    (import "$root" "[error-context-debug-message-latin1+utf16]" (func (;18;) (type 1) (param i32 i32)))
    (import "$root" "[error-context-drop]" (func (;19;) (type 4) (param i32)))
    (import "$root" "[context-get-0]" (func (;20;) (type 2) (result i32)))
    (import "$root" "[context-set-0]" (func (;21;) (type 4) (param i32)))
    (memory (;0;) 1)
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (type (;1;) (func (param i32 i32)))
    (type (;2;) (func))
    (import "actual" "0" (func $0 (;0;) (type 0) (param i32 i32) (result i32)))
    (import "shim" "g0" (global $g0 (;0;) (mut (ref 0))))
    (import "actual" "1" (func $1 (;1;) (type 0) (param i32 i32) (result i32)))
    (import "shim" "g1" (global $g1 (;1;) (mut (ref 0))))
    (import "actual" "2" (func $2 (;2;) (type 0) (param i32 i32) (result i32)))
    (import "shim" "g2" (global $g2 (;2;) (mut (ref 0))))
    (import "actual" "3" (func $3 (;3;) (type 0) (param i32 i32) (result i32)))
    (import "shim" "g3" (global $g3 (;3;) (mut (ref 0))))
    (import "actual" "4" (func $4 (;4;) (type 0) (param i32 i32) (result i32)))
    (import "shim" "g4" (global $g4 (;4;) (mut (ref 0))))
    (import "actual" "5" (func $5 (;5;) (type 1) (param i32 i32)))
    (import "shim" "g5" (global $g5 (;5;) (mut (ref 1))))
    (import "actual" "6" (func $6 (;6;) (type 1) (param i32 i32)))
    (import "shim" "g6" (global $g6 (;6;) (mut (ref 1))))
    (import "actual" "7" (func $7 (;7;) (type 1) (param i32 i32)))
    (import "shim" "g7" (global $g7 (;7;) (mut (ref 1))))
    (import "actual" "8" (func $8 (;8;) (type 1) (param i32 i32)))
    (import "shim" "g8" (global $g8 (;8;) (mut (ref 1))))
    (import "actual" "9" (func $9 (;9;) (type 1) (param i32 i32)))
  ...
  (alias core export $main "cabi_realloc" (core func $cabi_realloc (;27;)))
  (core func $error-context.debug-message (;28;) (canon error-context.debug-message (memory $memory) (realloc $cabi_realloc) string-encoding=utf8))
  (core func $"#core-func29 error-context.debug-message" (@name "error-context.debug-message") (;29;) (canon error-context.debug-message (memory $memory) (realloc $cabi_realloc) string-encoding=utf16))
  (core func $"#core-func30 error-context.debug-message" (@name "error-context.debug-message") (;30;) (canon error-context.debug-message (memory $memory) (realloc $cabi_realloc) string-encoding=latin1+utf16))
  ...
  (func $"#func2 foo" (@name "foo") (;2;) (type 0) (canon lift (core func $"[async-lift-stackful]foo:foo/bar#foo") (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 async))
