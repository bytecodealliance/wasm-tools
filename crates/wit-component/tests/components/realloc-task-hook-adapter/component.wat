(component
  ...
  (core module $wit-component:adapter:old (;1;)
    ...
    (import "new" "read" (func $read (;0;) (type 0) (param i32 i32)))
  ...
  (core module $wit-component-fixup (;3;)
    ...
    (import "actual" "2" (func $2 (;2;) (type 1) (param i32 i32 i32 i32) (result i32)))
    (import "main" "__wasm_task_hook" (func $__wasm_task_hook (;3;) (type 2) (param i32)))
    (import "old" "entrypoint" (func $entrypoint (;4;) (type 0) (param i32 i32)))
    (import "main" "cabi_realloc" (func $cabi_realloc (;5;) (type 1) (param i32 i32 i32 i32) (result i32)))
    (import "old" "cabi_export_realloc" (func $cabi_export_realloc (;6;) (type 1) (param i32 i32 i32 i32) (result i32)))
    (import "old" "cabi_import_realloc" (func $cabi_import_realloc (;7;) (type 1) (param i32 i32 i32 i32) (result i32)))
