(component
  (core module $main (;0;)
    ...
    (import "[export]foo" "[resource-new]a" (func $new (;0;) (type 0) (param i32) (result i32)))
    (import "[export]foo" "[resource-rep]a" (func (;1;) (type 0) (param i32) (result i32)))
    (import "[export]foo" "[resource-drop]a" (func (;2;) (type 1) (param i32)))
  ...
  (core module $wit-component-shim-module (;1;)
    ...
    (func $"trap stub before initialization" (;0;) (type 0) (param i32)
      unreachable
    )
    (func $dtor-a (;1;) (type 0) (param i32)
      local.get 0
      global.get 0
      return_call_ref 0
    )
