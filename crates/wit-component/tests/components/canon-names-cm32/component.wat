(component
  ...
  (import "ns:pkg/i@0.2" (versionsuffix ".1") (instance $ns:pkg/i@0.2 (;0;) (type $ty-ns:pkg/i@0.2)))
  (type $ty-j (;1;)
    (instance
      (export (;0;) "r" (type (sub resource)))
      (type (;1;) (own 0))
  ...
  (alias export $ns:pkg/i@0.2 "frob" (func $frob (;1;)))
  (core func $frob (;5;) (canon lower (func $frob)))
  (alias export $ns:pkg/i@0.2 "r" (type $"#type5 r" (@name "r") (;5;)))
  ...
  (alias export $ns:pkg/i@0.2 "[constructor]r" (func $"[constructor]r" (;3;)))
  ...
  (alias export $ns:pkg/i@0.2 "[method]r.m" (func $"[method]r.m" (;4;)))
  ...
  (component $ns:pkg/i@0.2-shim-component (;0;)
  ...
  (instance $ns:pkg/i@0.2-shim-instance (;2;) (instantiate $ns:pkg/i@0.2-shim-component
  ...
  (export $"#instance3 ns:pkg/i@0.2" (@name "ns:pkg/i@0.2") (;3;) "ns:pkg/i@0.2" (versionsuffix ".1") (instance $ns:pkg/i@0.2-shim-instance))
  (type (;12;) (own $"#type4 r"))
