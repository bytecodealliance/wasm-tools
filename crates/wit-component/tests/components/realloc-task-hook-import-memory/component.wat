(component
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "main" "__wasm_task_hook" (func $__wasm_task_hook (;1;) (type 1) (param i32)))
    (import "main" "takes-and-returns" (func $takes-and-returns (;2;) (type 2) (param i32 i32) (result i32)))
    (import "main" "cabi_realloc" (func $cabi_realloc (;3;) (type 0) (param i32 i32 i32 i32) (result i32)))
