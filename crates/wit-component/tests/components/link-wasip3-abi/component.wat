(component
  ...
  (core module $foo (;2;)
    ...
    (import "env" "__wasm_get_stack_pointer" (func $__wasm_get_stack_pointer (;0;) (type 2) (result i32)))
    (import "env" "__wasm_set_stack_pointer" (func $__wasm_set_stack_pointer (;1;) (type 3) (param i32)))
    (import "env" "malloc" (func $malloc (;2;) (type 1) (param i32) (result i32)))
    (import "env" "abort" (func $abort (;3;) (type 0)))
    (import "GOT.mem" "um" (global $um (;2;) (mut i32)))
    (import "test:test/test" "bar" (func $bar (;4;) (type 1) (param i32) (result i32)))
  ...
  (core module $wit-component-fixup (;4;)
    ...
    (import "c" "__wasm_task_hook" (func $__wasm_task_hook (;4;) (type 1) (param i32)))
    (import "main" "__wasm_task_hook" (func $"#func5 __wasm_task_hook" (@name "__wasm_task_hook") (;5;) (type 1) (param i32)))
    (import "bar" "test:test/test#bar" (func $test:test/test#bar (;6;) (type 2) (param i32) (result i32)))
