(component
  (core module $main (;0;)
    ...
    (import "$root" "[future-read-unit]" (func (;22;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[future-write-unit]" (func (;23;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[stream-read-unit]" (func (;24;) (type 6) (param i32 i32 i32) (result i32)))
    (import "$root" "[stream-write-unit]" (func (;25;) (type 6) (param i32 i32 i32) (result i32)))
    (import "$root" "[future-write-0]a" (func (;26;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[future-read-0]a" (func (;27;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[stream-write-0]b" (func (;28;) (type 6) (param i32 i32 i32) (result i32)))
    (import "$root" "[stream-read-0]b" (func (;29;) (type 6) (param i32 i32 i32) (result i32)))
    (import "$root" "[future-write-0]c" (func (;30;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[future-read-0]c" (func (;31;) (type 3) (param i32 i32) (result i32)))
    (import "$root" "[stream-write-0]d" (func (;32;) (type 6) (param i32 i32 i32) (result i32)))
    (import "$root" "[stream-read-0]d" (func (;33;) (type 6) (param i32 i32 i32) (result i32)))
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "actual" "2" (func $2 (;2;) (type 0) (param i32 i32)))
    (import "actual" "3" (func $3 (;3;) (type 1) (param i32 i32) (result i32)))
    (import "actual" "4" (func $4 (;4;) (type 2) (param i32 i32 i32) (result i32)))
