(component
  (core module (;0;)
    ...
    (export "foo/my-default#a" (func 1))
    (export "foo/my-default#b" (func 2))
    (export "foo/my-default#c" (func 3))
    (export "foo/my-default#d" (func 4))
    (export "foo/my-default#e" (func 5))
    (export "foo/my-default#f" (func 6))
    (export "foo/my-default#g" (func 7))
    (export "foo/my-default#h" (func 8))
    (export "foo/my-default#i" (func 9))
    (export "foo/my-default#j" (func 10))
    (export "foo/my-default#k" (func 11))
    (export "foo/my-default#l" (func 12))
    (export "cabi_post_foo/my-default#l" (func 13))
    (export "foo/my-default#m" (func 14))
    (export "cabi_post_foo/my-default#m" (func 15))
    (export "foo/my-default#n" (func 16))
    (export "foo/my-default#o" (func 17))
    (export "cabi_post_foo/my-default#o" (func 18))
    (export "foo/my-default#p" (func 19))
    (export "cabi_post_foo/my-default#p" (func 20))
    (@producers
  ...
  (type (;0;) (func))
  (alias core export 0 "foo/my-default#a" (core func (;1;)))
  (func (;0;) (type 0) (canon lift (core func 1)))
  (type (;1;) (list string))
  (type (;2;) (func (param "x" 1)))
  (alias core export 0 "foo/my-default#b" (core func (;2;)))
  ...
  (alias core export 0 "foo/my-default#c" (core func (;3;)))
  ...
  (alias core export 0 "foo/my-default#d" (core func (;4;)))
  ...
  (component (;0;)
    ...
    (type (;30;) (func))
    (export (;16;) "a" (func 0) (func (type 30)))
    (type (;31;) (list string))
    (type (;32;) (func (param "x" 31)))
    (export (;17;) "b" (func 1) (func (type 32)))
    (type (;33;) (record (field "s" string)))
    (export (;34;) "r" (type 33))
    (type (;35;) (func (param "x" 34)))
    (export (;18;) "c" (func 2) (func (type 35)))
    (type (;36;) (variant (case "s" string)))
    (export (;37;) "v" (type 36))
    (type (;38;) (func (param "x" 37)))
    (export (;19;) "d" (func 3) (func (type 38)))
    (type (;39;) (record (field "s" u32)))
    (export (;40;) "r-no-string" (type 39))
    (type (;41;) (func (param "x" 40)))
    (export (;20;) "e" (func 4) (func (type 41)))
    (type (;42;) (variant (case "s" u32)))
    (export (;43;) "v-no-string" (type 42))
    (type (;44;) (func (param "x" 43)))
  ...
  (export (;1;) (interface "foo/my-default") (instance 0))
)