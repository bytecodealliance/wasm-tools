(component
  ...
  (component (;0;)
    ...
    (type (;1;) (list string))
    (type (;2;) (func (param "x" 1)))
    (import "import-b" (func (;1;) (type 2)))
    (type (;3;) (record (field "s" string)))
    (import "import-r" (type (;4;) (eq 3)))
    (type (;5;) (func (param "x" 4)))
    (import "import-c" (func (;2;) (type 5)))
    (type (;6;) (variant (case "s" string)))
    (import "import-v" (type (;7;) (eq 6)))
    (type (;8;) (func (param "x" 7)))
    (import "import-d" (func (;3;) (type 8)))
    (type (;9;) (record (field "s" u32)))
    (import "import-r-no-string" (type (;10;) (eq 9)))
    (type (;11;) (func (param "x" 10)))
    (import "import-e" (func (;4;) (type 11)))
    (type (;12;) (variant (case "s" u32)))
    (import "import-v-no-string" (type (;13;) (eq 12)))
    (type (;14;) (func (param "x" 13)))
    (import "import-f" (func (;5;) (type 14)))
    (type (;15;) (list 4))
    (type (;16;) (func (param "x" 15)))
    (import "import-g" (func (;6;) (type 16)))
    (type (;17;) (list 7))
    (type (;18;) (func (param "x" 17)))
    (import "import-h" (func (;7;) (type 18)))
    (type (;19;) (list u32))
    (type (;20;) (func (param "x" 19)))
    (import "import-i" (func (;8;) (type 20)))
    (type (;21;) (func (param "x" u32)))
    (import "import-j" (func (;9;) (type 21)))
    (type (;22;) (tuple u32 u32))
    (type (;23;) (func (result 22)))
    (import "import-k" (func (;10;) (type 23)))
    (type (;24;) (func (result string)))
    (import "import-l" (func (;11;) (type 24)))
    (type (;25;) (func (result 19)))
    (import "import-m" (func (;12;) (type 25)))
    (type (;26;) (func (result u32)))
    (import "import-n" (func (;13;) (type 26)))
    (type (;27;) (func (result 7)))
    (import "import-o" (func (;14;) (type 27)))
    (type (;28;) (list 13))
    (type (;29;) (func (result 28)))
    (import "import-p" (func (;15;) (type 29)))
    (type (;30;) (func))
  ...
  (instance (;0;) (instantiate 0
      ...
      (with "import-r" (type 3))
      (with "import-v" (type 5))
      (with "import-r-no-string" (type 7))
      (with "import-v-no-string" (type 9))
    )
  )
