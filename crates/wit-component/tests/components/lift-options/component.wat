(component
  ...
  (component (;0;)
    ...
    (import "e" (func (;4;) (type 4)))
    (alias outer 1 10 (type (;5;)))
    (import "f" (func (;5;) (type 5)))
    (alias outer 1 12 (type (;6;)))
    (import "g" (func (;6;) (type 6)))
    (alias outer 1 14 (type (;7;)))
    (import "h" (func (;7;) (type 7)))
    (alias outer 1 16 (type (;8;)))
    (import "i" (func (;8;) (type 8)))
    (alias outer 1 17 (type (;9;)))
    (import "j" (func (;9;) (type 9)))
    (alias outer 1 19 (type (;10;)))
    (import "k" (func (;10;) (type 10)))
    (alias outer 1 20 (type (;11;)))
    (import "l" (func (;11;) (type 11)))
    (alias outer 1 21 (type (;12;)))
    (import "m" (func (;12;) (type 12)))
    (alias outer 1 22 (type (;13;)))
    (import "n" (func (;13;) (type 13)))
    (alias outer 1 23 (type (;14;)))
    (import "o" (func (;14;) (type 14)))
    (alias outer 1 25 (type (;15;)))
    (import "p" (func (;15;) (type 15)))
    (type (;16;) (func))
