(module
  ...
  (func (export "cabi_post_l") (param i32) unreachable)
  (func (export "m") (result i32) unreachable)
  (func (export "cabi_post_m") (param i32) unreachable)
  (func (export "n") (result i32) unreachable)
  (func (export "o") (result i32) unreachable)
  (func (export "cabi_post_o") (param i32) unreachable)
  (func (export "p") (result i32) unreachable)
  (func (export "cabi_post_p") (param i32) unreachable)
)
