(component
  ...
  (core module $main (;0;)
    ...
    (import "$root" "returns-string" (func (;0;) (type 0) (param i32)))
    (import "$root" "takes-string" (func (;1;) (type 1) (param i32 i32)))
    (memory (;0;) 1)
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "actual" "1" (func $1 (;1;) (type 1) (param i32 i32 i32 i32) (result i32)))
    (import "actual" "2" (func $2 (;2;) (type 2) (param i32 i32)))
    (import "actual" "3" (func $3 (;3;) (type 0) (param i32)))
    (import "main" "__wasm_task_hook" (func $__wasm_task_hook (;4;) (type 0) (param i32)))
    (import "main" "takes-and-returns" (func $takes-and-returns (;5;) (type 3) (param i32 i32) (result i32)))
    (import "main" "cabi_post_takes-and-returns" (func $cabi_post_takes-and-returns (;6;) (type 0) (param i32)))
    (import "main" "no-realloc" (func $no-realloc (;7;) (type 4)))
    (import "main" "x#with-string" (func $x#with-string (;8;) (type 2) (param i32 i32)))
    (import "main" "cabi_import_realloc" (func $cabi_import_realloc (;9;) (type 1) (param i32 i32 i32 i32) (result i32)))
    (import "main" "cabi_export_realloc" (func $cabi_export_realloc (;10;) (type 1) (param i32 i32 i32 i32) (result i32)))
