(component
  (core module $main (;0;)
    ...
    (global (;4;) (mut i32) i32.const 1048576)
    (global (;5;) (mut i32) i32.const 0)
    (global (;6;) i32 i32.const 1048592)
    (global (;7;) i32 i32.const 1)
    (global (;8;) i32 i32.const 1048608)
    (global (;9;) i32 i32.const 1)
    (global (;10;) (mut i32) i32.const 1048624)
    ...
    (export "bar:memory_base" (global 6))
    (export "bar:table_base" (global 7))
