(component
  ...
  (core module $main (;0;)
    ...
    (import "foo:foo/bar" "a" (func (;1;) (type 1) (param i64 i32 i32)))
    (import "foo:foo/baz" "baz" (func (;2;) (type 2) (param i32 i32 i32)))
    (memory (;0;) 1)
  ...
  (core module $wit-component-fixup (;2;)
    (type (;0;) (func (param i64 i32 i32)))
    (type (;1;) (func (param i32 i32 i32)))
    (import "actual" "0" (func $0 (;0;) (type 0) (param i64 i32 i32)))
  ...
  (core func $"#core-func3 indirect-foo:foo/bar-a" (@name "indirect-foo:foo/bar-a") (;3;) (canon lower (func $"#func1 a") (memory $memory) string-encoding=utf8))
  (alias export $foo:foo/baz "baz" (func $baz (;2;)))
  (alias core export $main "cabi_realloc" (core func $cabi_realloc (;4;)))
  (core func $"#core-func5 indirect-foo:foo/baz-baz" (@name "indirect-foo:foo/baz-baz") (;5;) (canon lower (func $baz) (memory $memory) (realloc $cabi_realloc)))
  (core instance $actual (;5;)
    (export "0" (func $"#core-func3 indirect-foo:foo/bar-a"))
