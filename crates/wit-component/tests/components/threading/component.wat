(component
  (core module $main (;0;)
    ...
    (import "$root" "[thread-resume-later]" (func (;7;) (type $thread-start-func-ty)))
    (import "$root" "[thread-suspend]" (func (;8;) (type 3)))
    (import "$root" "[thread-suspend-then-resume]" (func (;9;) (type 5)))
    (import "$root" "[thread-yield-then-resume]" (func (;10;) (type 5)))
    (import "$root" "[thread-suspend-then-promote]" (func (;11;) (type 5)))
    (import "$root" "[thread-yield-then-promote]" (func (;12;) (type 5)))
    (table (;0;) 1 1 funcref)
    (memory (;0;) 1)
