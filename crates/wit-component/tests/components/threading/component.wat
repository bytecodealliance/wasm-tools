(component
  (core module $main (;0;)
    ...
    (import "[export]$root" "[task-return]foo" (func (;1;) (type 2) (param i32 i32)))
    (import "[export]foo:foo/bar" "[task-return]foo" (func (;2;) (type 2) (param i32 i32)))
    (import "$root" "[context-get-1]" (func (;3;) (type 3) (result i32)))
    (import "$root" "[context-set-1]" (func (;4;) (type $thread-start-func-ty) (param i32)))
    (import "$root" "[thread-index]" (func (;5;) (type 3) (result i32)))
    (import "$root" "[thread-new-indirect-v0]" (func (;6;) (type 4) (param i32 i32) (result i32)))
    (import "$root" "[thread-resume-later]" (func (;7;) (type $thread-start-func-ty) (param i32)))
    (import "$root" "[thread-suspend]" (func (;8;) (type 3) (result i32)))
    (import "$root" "[thread-suspend-then-resume]" (func (;9;) (type 5) (param i32) (result i32)))
    (import "$root" "[thread-yield-then-resume]" (func (;10;) (type 5) (param i32) (result i32)))
    (import "$root" "[thread-suspend-then-promote]" (func (;11;) (type 5) (param i32) (result i32)))
    (import "$root" "[thread-yield-then-promote]" (func (;12;) (type 5) (param i32) (result i32)))
    (table (;0;) 1 1 funcref)
    (memory (;0;) 1)
    (export "thread_main" (func 13))
    (export "[async-lift-stackful]foo" (func 14))
    (export "[async-lift-stackful]foo:foo/bar#foo" (func 15))
    (export "memory" (memory 0))
    (export "__indirect_function_table" (table 0))
    (export "cabi_realloc" (func 16))
    (elem (;0;) (i32.const 0) func 0)
    (func (;13;) (type $thread-start-func-ty) (param i32)
      unreachable
    )
  ...
  (core func $thread.resume-later (;7;) (canon thread.resume-later))
  (core func $thread.suspend (;8;) (canon thread.suspend))
  (core func $thread.suspend-then-resume (;9;) (canon thread.suspend-then-resume))
  (core func $thread.yield-then-resume (;10;) (canon thread.yield-then-resume))
  (core func $thread.suspend-then-promote (;11;) (canon thread.suspend-then-promote))
  (core func $"#core-func12 thread.yield-then-resume" (@name "thread.yield-then-resume") (;12;) (canon thread.yield-then-promote))
  (core instance $$root (;3;)
    ...
    (export "[thread-yield-then-promote]" (func $"#core-func12 thread.yield-then-resume"))
  )
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "actual" "2" (func $2 (;2;) (type 1) (param i32 i32) (result i32)))
  ...
  (alias core export $main "cabi_realloc" (core func $realloc (;13;)))
  (core func $task.return (;14;) (canon task.return (result string) (memory $memory) string-encoding=utf8))
  ...
  (core instance $actual (;5;)
    ...
    (export "1" (func $"#core-func15 task.return"))
    (export "2" (func $"#core-func16 thread.new-indirect"))
  )
  ...
  (alias core export $main "[async-lift-stackful]foo" (core func $"[async-lift-stackful]foo" (;17;)))
  ...
  (alias core export $main "[async-lift-stackful]foo:foo/bar#foo" (core func $"[async-lift-stackful]foo:foo/bar#foo" (;18;)))
