(component
  ...
  (core module $main (;0;)
    ...
    (import "$root" "[async-lower]foo" (func (;0;) (type 0) (param i32) (result i32)))
    (import "$root" "[stream-new-0]foo" (func (;1;) (type 1) (result i64)))
    (import "$root" "[stream-read-0]foo" (func (;2;) (type 2) (param i32 i32 i32) (result i32)))
    (import "$root" "[stream-write-0]foo" (func (;3;) (type 2) (param i32 i32 i32) (result i32)))
    (import "$root" "[stream-drop-readable-0]foo" (func (;4;) (type 3) (param i32)))
    (import "$root" "[stream-drop-writable-0]foo" (func (;5;) (type 3) (param i32)))
    (memory (;0;) 1)
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "actual" "1" (func $1 (;1;) (type 0) (param i32 i32 i32) (result i32)))
