(component
  ...
  (core module $main (;0;)
    (table (;0;) 4 funcref)
    (memory (;0;) 17)
    (global (;0;) i32 i32.const 1048704)
    ...
    (global (;6;) (mut i32) i32.const 1049120)
    (global (;7;) (mut i32) i32.const 1114112)
    (export "foo:memory_base" (global 0))
    (export "foo:table_base" (global 1))
    (export "libc.so:memory_base" (global 2))
    (export "libc.so:table_base" (global 3))
    (export "libdl.so:memory_base" (global 4))
    (export "libdl.so:table_base" (global 5))
