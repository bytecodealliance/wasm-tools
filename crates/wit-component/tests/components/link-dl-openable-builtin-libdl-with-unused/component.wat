(component
  ...
  (core module $main (;0;)
    ...
    (global (;4;) i32 i32.const 1048704)
    (global (;5;) i32 i32.const 4)
    (global (;6;) i32 i32.const 1048704)
    (global (;7;) i32 i32.const 4)
    (global (;8;) i32 i32.const 1048704)
    (global (;9;) i32 i32.const 4)
    (global (;10;) (mut i32) i32.const 1049120)
    ...
    (export "libc.so:memory_base" (global 6))
    (export "libc.so:table_base" (global 7))
    (export "libdl.so:memory_base" (global 8))
    (export "libdl.so:table_base" (global 9))
  ...
  (core module $__init (;4;)
    ...
    (import "foo" "um" (global (;1;) i32))
    (import "foo" "what" (global (;2;) i32))
  ...
  (core instance $libdl.so (;4;) (instantiate $libdl.so
