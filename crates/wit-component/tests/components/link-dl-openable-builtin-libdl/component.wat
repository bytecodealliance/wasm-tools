(component
  ...
  (core module $main (;0;)
    ...
    (global (;6;) i32 i32.const 1049096)
    (global (;7;) i32 i32.const 4)
    (global (;8;) (mut i32) i32.const 1049104)
    ...
    (export "wit-component:stubs:memory_base" (global 6))
    (export "wit-component:stubs:table_base" (global 7))
