(component
  ...
  (core module $main (;0;)
    (table (;0;) 4 funcref)
    (memory (;0;) 17)
    (global (;0;) (mut i32) i32.const 1048676)
    ...
    (global (;7;) (mut i32) i32.const 1048848)
  ...
  (core module $libc.so (;1;)
    ...
    (export "__wasi_init_tp" (func 3))
    (export "memcmp" (func 4))
    (export "strlen" (func 5))
  ...
  (core module $libdl.so (;2;)
    ...
    (import "env" "strlen" (func (;0;) (type 0) (param i32) (result i32)))
    (import "env" "memcmp" (func (;1;) (type 1) (param i32 i32 i32) (result i32)))
  ...
  (core module $foo (;3;)
    ...
    (import "env" "dlopen" (func $dlopen (;1;) (type 1) (param i32 i32) (result i32)))
  ...
  (core module $wit-component-fixup (;4;)
    ...
    (import "foo" "bar" (func $bar (;1;) (type 1) (param i32) (result i32)))
    (import "foo" "baz" (func $baz (;2;) (type 1) (param i32) (result i32)))
    (import "foo" "test:test/test#foo" (func $test:test/test#foo (;3;) (type 1) (param i32) (result i32)))
    (start $start)
