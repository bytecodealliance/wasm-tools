(component
  ...
  (core module $main (;0;)
    ...
    (global (;4;) i32 i32.const 1048688)
    (global (;5;) i32 i32.const 4)
    (global (;6;) i32 i32.const 1048688)
    (global (;7;) i32 i32.const 4)
    (global (;8;) i32 i32.const 1048688)
    (global (;9;) i32 i32.const 4)
    (global (;10;) i32 i32.const 1049096)
    (global (;11;) i32 i32.const 4)
    (global (;12;) (mut i32) i32.const 1049104)
    ...
    (export "wit-component:stubs:memory_base" (global 10))
    (export "wit-component:stubs:table_base" (global 11))
