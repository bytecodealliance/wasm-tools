(component
  ...
  (core module $wit-component-shim-module (;3;)
    ...
    (func $adapt-foo-cabi_realloc (;1;) (type 0) (param i32 i32 i32 i32) (result i32)
      local.get 0
      local.get 1
      local.get 2
      local.get 3
    ...
    (func $"#func2 trap stub before initialization" (@name "trap stub before initialization") (;2;) (type 1) (param i32)
      unreachable
    )
    (func $indirect-$root-bar (;3;) (type 1) (param i32)
      local.get 0
      global.get 1
      return_call_ref 1
    )
  ...
  (alias core export $"#core-instance7 foo" "cabi_import_realloc" (core func $cabi_import_realloc (;4;)))
  (core func $"#core-func5 indirect-$root-bar" (@name "indirect-$root-bar") (;5;) (canon lower (func $bar) (memory $memory) (realloc $cabi_import_realloc) string-encoding=utf8))
  ...
  (alias core export $"#core-instance7 foo" "foo2" (core func $foo2 (;7;)))
  (alias core export $"#core-instance7 foo" "cabi_export_realloc" (core func $cabi_export_realloc (;8;)))
