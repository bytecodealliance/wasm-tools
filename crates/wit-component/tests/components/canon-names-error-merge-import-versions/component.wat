(component
  ...
  (import "a:b/c@0.1" (versionsuffix ".1") (instance $a:b/c@0.1 (;0;) (type $ty-a:b/c@0.1)))
  (core module $main (;0;)
  ...
  (alias export $a:b/c@0.1 "r" (type $r (;1;)))
