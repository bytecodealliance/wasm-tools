(component
  ...
  (core module $main (;0;)
    ...
    (import "$root" "returns-list" (func (;1;) (type 0) (param i32)))
    (import "$root" "returns-string2" (func (;2;) (type 1) (param i32 i32)))
    (import "$root" "takes-string" (func (;3;) (type 1) (param i32 i32)))
    (import "$root" "no-options" (func (;4;) (type 2) (param i32) (result i32)))
