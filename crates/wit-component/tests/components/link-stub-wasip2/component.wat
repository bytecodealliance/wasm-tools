(component
  ...
  (core instance (;8;) (instantiate 2
      ...
      (with "env" (instance 6))
      (with "wasi:cli/environment@0.2.0" (instance 7))
    )
  )
  (alias core export 2 "foo:um" (core global (;5;)))
  (alias core export 2 "__heap_base" (core global (;6;)))
  (alias core export 2 "__heap_end" (core global (;7;)))
  (core instance (;9;)
    (export "um" (global 5))
  ...
  (alias core export 2 "__stack_pointer" (core global (;8;)))
  (alias core export 2 "foo:memory_base" (core global (;9;)))
  (alias core export 2 "foo:table_base" (core global (;10;)))
  (alias core export 8 "abort" (core func (;2;)))
  (alias core export 8 "malloc" (core func (;3;)))
  (core instance (;11;)
  ...
  (alias core export 2 "bar:well" (core global (;11;)))
  (alias core export 2 "__heap_base" (core global (;12;)))
  (alias core export 2 "__heap_end" (core global (;13;)))
  (core instance (;14;)
  ...
  (alias core export 2 "__stack_pointer" (core global (;14;)))
  (alias core export 2 "bar:memory_base" (core global (;15;)))
  (alias core export 2 "bar:table_base" (core global (;16;)))
  (alias core export 13 "foo" (core func (;5;)))
  (core instance (;16;)
  ...
  (core instance (;17;) (instantiate 4
      (with "GOT.mem" (instance 14))
      (with "GOT.func" (instance 15))
      (with "env" (instance 16))
    )
  )
  (alias core export 0 "$imports" (core table (;3;)))
  (alias core export 3 "get-environment" (core func (;6;)))
  (core instance (;18;)
    (export "$imports" (table 3))
    (export "0" (func 6))
  )
  (core instance (;19;) (instantiate 7
      (with "" (instance 18))
    )
  )
  (core instance (;20;) (instantiate 5
      (with "env" (instance 2))
      (with "bar" (instance 17))
      (with "c" (instance 8))
      (with "foo" (instance 13))
    )
  )
  (type (;1;) (func (param "v" s32) (result s32)))
  (alias core export 17 "test:test/test#bar" (core func (;7;)))
