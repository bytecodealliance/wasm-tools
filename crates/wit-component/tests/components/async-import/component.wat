(component
  ...
  (core module $main (;0;)
    ...
    (import "$root" "[async-lower]foo" (func (;0;) (type 0) (param i32 i32 i32) (result i32)))
    (import "foo:foo/bar" "[async-lower]foo" (func (;1;) (type 0) (param i32 i32 i32) (result i32)))
    (import "$root" "foo" (func (;2;) (type 1) (param i32 i32 i32)))
    (import "foo:foo/bar" "foo" (func (;3;) (type 1) (param i32 i32 i32)))
    (memory (;0;) 1)
  ...
  (core module $wit-component-fixup (;2;)
    (type (;0;) (func (param i32 i32 i32) (result i32)))
    (type (;1;) (func (param i32 i32 i32)))
    (import "actual" "0" (func $0 (;0;) (type 0) (param i32 i32 i32) (result i32)))
    (import "actual" "1" (func $1 (;1;) (type 1) (param i32 i32 i32)))
    (import "actual" "2" (func $2 (;2;) (type 0) (param i32 i32 i32) (result i32)))
    (import "actual" "3" (func $3 (;3;) (type 1) (param i32 i32 i32)))
  ...
  (core func $"#core-func5 indirect-$root-[async-lower]foo" (@name "indirect-$root-[async-lower]foo") (;5;) (canon lower (func $foo) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 async))
  (core func $"#core-func6 indirect-$root-foo" (@name "indirect-$root-foo") (;6;) (canon lower (func $foo) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8))
  (alias export $foo:foo/bar "foo" (func $"#func1 foo" (@name "foo") (;1;)))
  (core func $"#core-func7 indirect-foo:foo/bar-[async-lower]foo" (@name "indirect-foo:foo/bar-[async-lower]foo") (;7;) (canon lower (func $"#func1 foo") (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 async))
  (alias export $foo:foo/bar "foo" (func $"#func2 foo" (@name "foo") (;2;)))
  (core func $"#core-func8 indirect-foo:foo/bar-foo" (@name "indirect-foo:foo/bar-foo") (;8;) (canon lower (func $"#func2 foo") (memory $memory) (realloc $cabi_realloc) string-encoding=utf8))
