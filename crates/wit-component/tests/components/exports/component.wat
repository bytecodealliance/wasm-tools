(component
  ...
  (alias core export $main "b" (core func $b (;1;)))
  (alias core export $main "cabi_post_b" (core func $cabi_post_b (;2;)))
  ...
  (alias core export $main "foo#a" (core func $foo#a (;5;)))
  (func $"#func7 a" (@name "a") (;7;) (type 2) (canon lift (core func $foo#a)))
  (type (;7;) (func (param "x" string) (result 1)))
  (alias core export $main "foo#b" (core func $foo#b (;6;)))
  (alias core export $main "cabi_realloc" (core func $cabi_realloc (;7;)))
  (alias core export $main "cabi_post_foo#b" (core func $cabi_post_foo#b (;8;)))
  (func $"#func8 b" (@name "b") (;8;) (type 7) (canon lift (core func $foo#b) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 (post-return $cabi_post_foo#b)))
  (type (;8;) (func (param "x" 1) (result string)))
  (alias core export $main "foo#c" (core func $foo#c (;9;)))
  (alias core export $main "cabi_post_foo#c" (core func $cabi_post_foo#c (;10;)))
  (func $"#func9 c" (@name "c") (;9;) (type 8) (canon lift (core func $foo#c) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 (post-return $cabi_post_foo#c)))
