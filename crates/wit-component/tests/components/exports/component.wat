(component
  ...
  (func (;6;) (type 6) (canon lift (core func 8) (memory 0) string-encoding=utf8 (post-return 9)))
  (export (;7;) "b" (func 6))
  (type (;7;) (tuple s8 s16 s32 s64))
  (type (;8;) (func (result 7)))
  (alias core export 0 "c" (core func (;10;)))
  (func (;8;) (type 8) (canon lift (core func 10) (memory 0)))
  (@producers
    (processed-by "wit-component" "$CARGO_PKG_VERSION")
  )
  (export (;9;) "c" (func 8))
