(component
  ...
  (component (;1;)
    ...
    (import "import-x" (type (;2;) (eq 1)))
    (type (;3;) (func (param "x" string) (result 2)))
    (import "import-b" (func (;1;) (type 3)))
    (type (;4;) (func (param "x" 2) (result string)))
    (import "import-c" (func (;2;) (type 4)))
    (type (;5;) (func))
