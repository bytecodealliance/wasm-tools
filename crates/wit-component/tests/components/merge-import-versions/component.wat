(component
  ...
  (core module $main (;0;)
    ...
    (type (;3;) (func))
    (import "a:b/c@0.1.0" "[constructor]r" (func (;0;) (type 0) (result i32)))
    (import "a:b/c@0.1.0" "[resource-drop]r" (func (;1;) (type 1) (param i32)))
    (import "a:b/c@0.1.0" "x" (func (;2;) (type 2) (param i32 i32)))
    (import "a:b/c@0.1.0" "x2" (func (;3;) (type 2) (param i32 i32)))
    (import "a:b/c@0.1.1" "[constructor]r" (func (;4;) (type 0) (result i32)))
    (import "a:b/c@0.1.1" "[resource-drop]r" (func (;5;) (type 1) (param i32)))
    (import "a:b/c@0.1.1" "[method]r.x" (func (;6;) (type 1) (param i32)))
    (import "a:b/c@0.1.1" "x" (func (;7;) (type 2) (param i32 i32)))
    (import "a:b/c@0.1.1" "x2" (func (;8;) (type 2) (param i32 i32)))
