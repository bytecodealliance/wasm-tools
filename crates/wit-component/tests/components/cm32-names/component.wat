(component
  ...
  (core module $main (;0;)
    ...
    (type (;6;) (func))
    (import "cm32p2" "f" (func (;0;) (type 0) (param i32)))
    (import "cm32p2|ns:pkg/i@0.2" "[constructor]r" (func (;1;) (type 1) (param i32 i32) (result i32)))
    (import "cm32p2|ns:pkg/i@0.2" "[method]r.m" (func (;2;) (type 2) (param i32 i32)))
    (import "cm32p2|ns:pkg/i@0.2" "frob" (func (;3;) (type 3) (param i32) (result i32)))
    (import "cm32p2|ns:pkg/i@0.2" "r_drop" (func (;4;) (type 0) (param i32)))
    (import "cm32p2|j" "[constructor]r" (func (;5;) (type 1) (param i32 i32) (result i32)))
    (import "cm32p2|j" "[method]r.m" (func (;6;) (type 2) (param i32 i32)))
    (import "cm32p2|j" "frob" (func (;7;) (type 3) (param i32) (result i32)))
    (import "cm32p2|j" "r_drop" (func (;8;) (type 0) (param i32)))
    (import "cm32p2|_ex_ns:pkg/i@0.2" "r_drop" (func (;9;) (type 0) (param i32)))
    (import "cm32p2|_ex_ns:pkg/i@0.2" "r_new" (func (;10;) (type 3) (param i32) (result i32)))
    (import "cm32p2|_ex_ns:pkg/i@0.2" "r_rep" (func (;11;) (type 3) (param i32) (result i32)))
    (import "cm32p2|_ex_j" "r_drop" (func (;12;) (type 0) (param i32)))
    (import "cm32p2|_ex_j" "r_new" (func (;13;) (type 3) (param i32) (result i32)))
    (import "cm32p2|_ex_j" "r_rep" (func (;14;) (type 3) (param i32) (result i32)))
    (memory (;0;) 0)
  ...
  (type $r (;3;) (resource (rep i32) (dtor $dtor-r)))
  (alias core export $wit-component-shim-instance "6" (core func $"#core-func1 dtor-r" (@name "dtor-r") (;1;)))
  (type $"#type4 r" (@name "r") (;4;) (resource (rep i32) (dtor $"#core-func1 dtor-r")))
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "actual" "1" (func $1 (;1;) (type 1) (param i32 i32) (result i32)))
    (import "actual" "2" (func $2 (;2;) (type 2) (param i32 i32)))
    (import "actual" "3" (func $3 (;3;) (type 1) (param i32 i32) (result i32)))
    (import "actual" "4" (func $4 (;4;) (type 2) (param i32 i32)))
    (import "actual" "5" (func $5 (;5;) (type 0) (param i32)))
    (import "actual" "6" (func $6 (;6;) (type 0) (param i32)))
    (import "main" "cm32p2_initialize" (func $cm32p2_initialize (;7;) (type 3)))
    (import "shim" "$imports" (table (;0;) 7 7 funcref))
  ...
  (alias core export $main "cm32p2_realloc" (core func $cm32p2_realloc (;17;)))
  (core func $"#core-func18 indirect-cm32p2-f" (@name "indirect-cm32p2-f") (;18;) (canon lower (func $f) (memory $memory) (realloc $cm32p2_realloc) string-encoding=utf8))
  ...
  (core func $"#core-func20 indirect-cm32p2|ns:pkg/i@0.2-[method]r.m" (@name "indirect-cm32p2|ns:pkg/i@0.2-[method]r.m") (;20;) (canon lower (func $"[method]r.m") (memory $memory) (realloc $cm32p2_realloc) string-encoding=utf8))
  ...
  (core func $"#core-func22 indirect-cm32p2|j-[method]r.m" (@name "indirect-cm32p2|j-[method]r.m") (;22;) (canon lower (func $"#func6 [method]r.m") (memory $memory) (realloc $cm32p2_realloc) string-encoding=utf8))
  ...
  (alias core export $main "cm32p2||g" (core func $cm32p2||g (;25;)))
  (alias core export $main "cm32p2||g_post" (core func $cm32p2||g_post (;26;)))
  ...
  (alias core export $main "cm32p2|ns:pkg/i@0.2|[constructor]r" (core func $"cm32p2|ns:pkg/i@0.2|[constructor]r" (;27;)))
  (func $"#func9 [constructor]r" (@name "[constructor]r") (;9;) (type 8) (canon lift (core func $"cm32p2|ns:pkg/i@0.2|[constructor]r") (memory $memory) (realloc $cm32p2_realloc) string-encoding=utf8))
  (type (;9;) (borrow $r))
  (type (;10;) (func (param "self" 9) (result string)))
  (alias core export $main "cm32p2|ns:pkg/i@0.2|[method]r.m" (core func $"cm32p2|ns:pkg/i@0.2|[method]r.m" (;28;)))
  ...
  (alias core export $main "cm32p2|ns:pkg/i@0.2|frob" (core func $cm32p2|ns:pkg/i@0.2|frob (;29;)))
  ...
  (alias core export $main "cm32p2|j|[constructor]r" (core func $"cm32p2|j|[constructor]r" (;30;)))
  (func $"#func12 [constructor]r" (@name "[constructor]r") (;12;) (type 13) (canon lift (core func $"cm32p2|j|[constructor]r") (memory $memory) (realloc $cm32p2_realloc) string-encoding=utf8))
  (type (;14;) (borrow $"#type4 r"))
  (type (;15;) (func (param "self" 14) (result string)))
  (alias core export $main "cm32p2|j|[method]r.m" (core func $"cm32p2|j|[method]r.m" (;31;)))
  ...
  (alias core export $main "cm32p2|j|frob" (core func $cm32p2|j|frob (;32;)))
