(component
  ...
  (core module $main (;0;)
    ...
    (import "foo" "foo2" (func (;1;) (type 1) (param i32)))
    (import "foo" "foo3" (func (;2;) (type 2) (param f32)))
    (import "bar" "bar1" (func (;3;) (type 3) (param i32 i32)))
    (import "bar" "bar2" (func (;4;) (type 1) (param i32)))
    (import "baz" "baz1" (func (;5;) (type 3) (param i32 i32)))
    (import "baz" "baz2" (func (;6;) (type 0)))
    (import "baz" "baz3" (func (;7;) (type 1) (param i32)))
    (memory (;0;) 1)
  ...
  (core func $"#core-func8 indirect-bar-bar1" (@name "indirect-bar-bar1") (;8;) (canon lower (func $bar1) (memory $memory) string-encoding=utf8))
  (alias export $baz "baz1" (func $baz1 (;7;)))
  (core func $"#core-func9 indirect-baz-baz1" (@name "indirect-baz-baz1") (;9;) (canon lower (func $baz1) (memory $memory) string-encoding=utf8))
  (core instance $actual (;5;)
    (export "0" (func $"#core-func8 indirect-bar-bar1"))
    (export "1" (func $"#core-func9 indirect-baz-baz1"))
  )
