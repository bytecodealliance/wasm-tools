(component
  ...
  (core module (;0;)
    ...
    (import "foo" "foo1: func() -> ()" (func (;0;) (type 0)))
    (import "foo" "foo2: func(x: u8) -> ()" (func (;1;) (type 1)))
    (import "foo" "foo3: func(x: float32) -> ()" (func (;2;) (type 2)))
    (import "bar" "bar1: func(x: string) -> ()" (func (;3;) (type 3)))
    (import "bar" "bar2: func(x: record { a: u8 }) -> ()" (func (;4;) (type 1)))
    (import "baz" "baz1: func(x: list<string>) -> ()" (func (;5;) (type 3)))
    (import "baz" "baz2: func() -> ()" (func (;6;) (type 0)))
    (import "baz" "baz3: func(x: s8) -> ()" (func (;7;) (type 1)))
  ...
  (core instance (;1;) 
    (export "bar1: func(x: string) -> ()" (func 0))
    (export "bar2: func(x: record { a: u8 }) -> ()" (func 1))
  )
  (core instance (;2;) 
    (export "baz1: func(x: list<string>) -> ()" (func 2))
    (export "baz2: func() -> ()" (func 3))
    (export "baz3: func(x: s8) -> ()" (func 4))
  )
  (core instance (;3;) 
    (export "foo1: func() -> ()" (func 5))
    (export "foo2: func(x: u8) -> ()" (func 6))
    (export "foo3: func(x: float32) -> ()" (func 7))
  )
