(component
  (core module $main (;0;)
    ...
    (global (;4;) i32 i32.const 1048584)
    (global (;5;) i32 i32.const 2)
    (global (;6;) i32 i32.const 1048584)
    (global (;7;) i32 i32.const 2)
    (global (;8;) (mut i32) i32.const 2)
    (global (;9;) (mut i32) i32.const 1048592)
