(component
  ...
  (core module $main (;0;)
    ...
    (import "foo" "a" (func (;0;) (type 0) (param i32)))
    (memory (;0;) 1)
  ...
  (core func $"#core-func2 indirect-foo-a" (@name "indirect-foo-a") (;2;) (canon lower (func $a) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8))
  ...
  (func $"#func1 a" (@name "a") (;1;) (type 2) (canon lift (core func $a) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 (post-return $cabi_post_a)))
