(component
  ...
  (func (;1;) (type 0) (canon lift (core func 3)))
  (alias core export 2 "bar#b" (core func (;4;)))
  (alias core export 2 "cabi_post_bar#b" (core func (;5;)))
  (func (;2;) (type 1) (canon lift (core func 4) (memory 0) string-encoding=utf8 (post-return 5)))
  (instance (;1;)
    (export "a" (func 1))
    (export "b" (func 2))
  )
  ...
  (func (;3;) (type 3) (canon lift (core func 6) (memory 0) (realloc 1) string-encoding=utf8 (post-return 7)))
  (export "a" (func 3))
)