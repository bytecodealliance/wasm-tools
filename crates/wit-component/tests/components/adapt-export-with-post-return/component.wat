(component
  ...
  (core module $wit-component:adapter:old (;1;)
    ...
    (type (;4;) (func))
    (import "__main_module__" "canonical_abi_realloc" (func $realloc (;0;) (type 0) (param i32 i32 i32 i32) (result i32)))
    (import "__main_module__" "canonical_abi_free" (func $free (;1;) (type 1) (param i32 i32 i32)))
