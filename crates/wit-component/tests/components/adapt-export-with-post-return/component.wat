(component
  ...
  (core module (;1;)
    ...
    (export "foo/new#foo" (func 2))
    (export "cabi_post_foo/new#foo" (func 3))
  )
  ...
  (alias core export 2 "foo/new#foo" (core func (;3;)))
  (alias core export 2 "cabi_post_foo/new#foo" (core func (;4;)))
  ...
  (export (;1;) (interface "foo/new") (instance 0))
)