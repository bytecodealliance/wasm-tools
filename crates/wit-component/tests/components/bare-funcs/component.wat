(component
  ...
  (core func $"#core-func3 indirect-$root-bar" (@name "indirect-$root-bar") (;3;) (canon lower (func $bar) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8))
  ...
  (func $foo2 (;4;) (type 4) (canon lift (core func $foo2) (memory $memory) (realloc $cabi_realloc) string-encoding=utf8 (post-return $cabi_post_foo2)))
