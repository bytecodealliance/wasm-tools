(component
  (core module $main (;0;)
    ...
    (import "$root" "[future-new-unit]foo" (func (;0;) (type 0) (result i64)))
    (import "$root" "[future-read-unit]foo" (func (;1;) (type 1) (param i32 i32) (result i32)))
    (import "$root" "[future-write-unit]foo" (func (;2;) (type 1) (param i32 i32) (result i32)))
    (import "$root" "[future-cancel-read-unit]foo" (func (;3;) (type 2) (param i32) (result i32)))
    (import "$root" "[future-cancel-write-unit]foo" (func (;4;) (type 2) (param i32) (result i32)))
    (import "$root" "[future-drop-readable-unit]foo" (func (;5;) (type 3) (param i32)))
    (import "$root" "[future-drop-writable-unit]foo" (func (;6;) (type 3) (param i32)))
    (import "$root" "[stream-new-unit]foo" (func (;7;) (type 0) (result i64)))
    (import "$root" "[stream-read-unit]foo" (func (;8;) (type 4) (param i32 i32 i32) (result i32)))
    (import "$root" "[stream-write-unit]foo" (func (;9;) (type 4) (param i32 i32 i32) (result i32)))
    (import "$root" "[stream-cancel-read-unit]foo" (func (;10;) (type 2) (param i32) (result i32)))
    (import "$root" "[stream-cancel-write-unit]foo" (func (;11;) (type 2) (param i32) (result i32)))
    (import "$root" "[stream-drop-readable-unit]foo" (func (;12;) (type 3) (param i32)))
    (import "$root" "[stream-drop-writable-unit]foo" (func (;13;) (type 3) (param i32)))
    (memory (;0;) 1)
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "actual" "2" (func $2 (;2;) (type 1) (param i32 i32 i32) (result i32)))
    (import "actual" "3" (func $3 (;3;) (type 1) (param i32 i32 i32) (result i32)))
