(component
  (type (;0;)
    (instance
      ...
      (export "v" (type (eq 6)))
      (type (;6;) (func (param "x" 6)))
      (export "d" (func (type 8)))
      (type (;7;) (record (field "s" u32)))
      (export "r-no-string" (type (eq 9)))
      (type (;8;) (func (param "x" 9)))
      (export "e" (func (type 11)))
      (type (;9;) (variant (case "s" u32)))
      (export "v-no-string" (type (eq 12)))
      (type (;10;) (func (param "x" 12)))
      (export "f" (func (type 14)))
      (type (;11;) (list 3))
      (type (;12;) (func (param "x" 15)))
      (export "g" (func (type 16)))
      (type (;13;) (list 6))
      (type (;14;) (func (param "x" 17)))
      (export "h" (func (type 18)))
      (type (;15;) (list u32))
      (type (;16;) (func (param "x" 19)))
      (export "i" (func (type 20)))
      (type (;17;) (func (param "x" u32)))
      (export "j" (func (type 21)))
      (type (;18;) (tuple u32 u32))
      (type (;19;) (func (result 22)))
      (export "k" (func (type 23)))
      (type (;20;) (func (result string)))
      (export "l" (func (type 24)))
      (type (;21;) (func (result 19)))
      (export "m" (func (type 25)))
      (type (;22;) (func (result u32)))
      (export "n" (func (type 26)))
      (type (;23;) (func (result 6)))
      (export "o" (func (type 27)))
      (type (;24;) (list 12))
      (type (;25;) (func (result 28)))
      (export "p" (func (type 29)))
    )
  )
