(component
  ...
  (core module $wit-component-fixup (;2;)
    ...
    (import "foo" "bar" (func $bar (;0;) (type 1) (param i32) (result i32)))
    (import "foo" "baz" (func $baz (;1;) (type 1) (param i32) (result i32)))
    (import "foo" "test:test/test#foo" (func $test:test/test#foo (;2;) (type 1) (param i32) (result i32)))
    (start $start)
