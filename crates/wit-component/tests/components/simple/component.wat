(component
  ...
  (core module (;0;)
    ...
    (export "a: func() -> ()" (func $a))
    (export "b: func() -> string" (func $b))
    (export "c: func(x: string) -> string" (func $c))
    (export "d: func(x: list<string>) -> ()" (func $d))
  )
  (core instance (;0;) (instantiate 0))
  (alias core export 0 "memory" (core memory (;0;)))
  (alias core export 0 "cabi_realloc" (core func (;0;)))
  (alias core export 0 "a: func() -> ()" (core func (;1;)))
  (alias core export 0 "b: func() -> string" (core func (;2;)))
  (alias core export 0 "c: func(x: string) -> string" (core func (;3;)))
  (alias core export 0 "d: func(x: list<string>) -> ()" (core func (;4;)))
