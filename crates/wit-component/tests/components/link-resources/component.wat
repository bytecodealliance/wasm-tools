(component
  ...
  (alias core export 0 "bar:memory_base" (core global (;8;)))
  (alias core export 0 "bar:table_base" (core global (;9;)))
  (core instance (;7;)
  ...
  (alias core export 4 "test:test/foo#[constructor]x" (core func (;0;)))
  (func (;0;) (type 3) (canon lift (core func 0)))
  (type (;4;) (borrow 0))
  (type (;5;) (func (param "self" 4) (result u32)))
  (alias core export 4 "test:test/foo#[method]x.get" (core func (;1;)))
  ...
  (type (;8;) (borrow 1))
  (type (;9;) (func (param "self" 8) (result u32)))
  (alias core export 8 "test:test/bar#[method]x.get" (core func (;3;)))
