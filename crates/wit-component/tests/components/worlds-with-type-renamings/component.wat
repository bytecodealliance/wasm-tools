(component
  ...
  (import (interface "foo/i") (instance (;0;) (type 0)))
  ...
  (core module (;0;)
    ...
    (type (;2;) (func))
    (import "foo/i" "the-func" (func (;0;) (type 2)))
    (func (;1;) (type 2)
      unreachable
    )
  ...
  (alias core export 1 "foo/i#the-func" (core func (;2;)))
  ...
  (export (;2;) (interface "foo/i") (instance 1))
)