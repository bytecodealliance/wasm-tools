(component
  ...
  (alias core export $"#core-instance4 old" "cabi_import_realloc" (core func $cabi_import_realloc (;3;)))
  (core func $"#core-func4 indirect-new-read" (@name "indirect-new-read") (;4;) (canon lower (func $read) (memory $memory) (realloc $cabi_import_realloc)))
