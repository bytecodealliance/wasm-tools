(component
  ...
  (type (;0;) (list string))
  (type (;1;) (func (param "args" 0)))
  (type (;2;) (list u8))
  (type (;3;) (func (param "amt" u32) (result 2)))
  (type (;4;)
    (instance
  ...
  (func (;1;) (type 1) (canon lift (core func 6) (memory 0) (realloc 2) string-encoding=utf8))
  (export "entrypoint" (func 1))
)