(component
  ...
  (component (;1;)
    ...
    (core module $module (;0;)
      ...
      (import "example:service/logging@0.1.0" "[method]logger.log" (func (;0;) (type 0) (param i32 i32 i32)))
      (import "example:service/logging@0.1.0" "get-logger" (func (;1;) (type 1) (result i32)))
      (import "[export]example:service/logging@0.1.0" "[resource-new]logger" (func (;2;) (type 2) (param i32) (result i32)))
      (memory $memory (;0;) 1)
