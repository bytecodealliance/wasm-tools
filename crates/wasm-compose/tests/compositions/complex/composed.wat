  ...
  (component (;1;)
    ...
    (type $i1 (;30;)
      (instance
        ...
        (alias outer 1 $f14 (type (;14;)))
        (export "n" (func (type 15)))
        (alias outer 1 $f15 (type (;15;)))
        (export "o" (func (type 16)))
        (alias outer 1 $f16 (type (;16;)))
        (export "p" (func (type 17)))
        (alias outer 1 $t4 (type (;17;)))
        (export "flags1" (type (eq 18)))
        (alias outer 1 $f17 (type (;18;)))
        (export "q" (func (type 20)))
        (alias outer 1 $t5 (type (;19;)))
        (export "enum1" (type (eq 21)))
        (alias outer 1 $f18 (type (;20;)))
        (export "r" (func (type 23)))
        (alias outer 1 $t6 (type (;21;)))
        (export "union1" (type (eq 24)))
        (alias outer 1 $f19 (type (;22;)))
        (export "s" (func (type 26)))
        (alias outer 1 $t7 (type (;23;)))
        (export "variant1" (type (eq 27)))
        (alias outer 1 $f20 (type (;24;)))
        (export "t" (func (type 29)))
        (alias outer 1 $f21 (type (;25;)))
        (export "u" (func (type 30)))
      )
    )
