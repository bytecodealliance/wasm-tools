(component
  ...
  (component (;1;)
    ...
    (core module $m0 (;0;)
      ...
      (import "a" "m" (func (;0;) (type 0) (param i32 i32)))
      (memory (;0;) 0)
    ...
    (core module $m2 (;2;)
      ...
      (type (;4;) (func (param i32 i32 i64 i32 i32 i32 i32 i32 i64 i64 f32 f64 i32 i32 i32)))
      (type (;5;) (func (param i32)))
      (import "" "0" (func (;0;) (type 0) (param i32 i32)))
      (import "" "1" (func (;1;) (type 1) (param i32 i32 i32 i32 i32 i32 i64 i64 f32 f64 i32 i32 i32)))
      (import "" "2" (func (;2;) (type 0) (param i32 i32)))
      (import "" "3" (func (;3;) (type 2) (param i32 i32 i32 i32 i32 i32 i64 i64 f32 f64 i32 i32 i32 i32 i32)))
      (import "" "4" (func (;4;) (type 3) (param i32 i32 i32 i32 i32 i32 i32 i64 i64 f32 f64 i32 i32 i32)))
      (import "" "5" (func (;5;) (type 4) (param i32 i32 i64 i32 i32 i32 i32 i32 i64 i64 f32 f64 i32 i32 i32)))
      (import "" "6" (func (;6;) (type 5) (param i32)))
