(component
  ...
  (core alias export 0 "1" (func))
  (core alias export 0 "2" (func))
  (core alias export 0 "3" (func))
  (core alias export 0 "4" (func))
  (core alias export 0 "5" (func))
  (core alias export 0 "6" (func))
