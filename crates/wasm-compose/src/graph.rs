...
mod test {
  ...
  (instance (;4;) (instantiate 2
    ...
    #[test]
    fn it_encodes_a_simple_composition_with_locked_dep() -> Result<()> {
        let mut graph = CompositionGraph::new();
        let a = graph.add_component(Component::from_bytes(
            "locked-dep=<foo:add@1.0.0>",
            b"(component
  (type (tuple u32 u32))
  (import \"i1\" (instance (export \"e1\" (func)) (export \"e3\" (func (param \"a\" u32)))))
  (import \"i2\" (func))
  ...
  (instance (;4;) (instantiate 2
    ...
    #[test]
    fn it_encodes_a_simple_composition_with_unlocked_dep() -> Result<()> {
        let mut graph = CompositionGraph::new();
        let a = graph.add_component(Component::from_bytes(
            "unlocked-dep=<foo:add@{>=1.0.0}>",
            b"(component
  (type (tuple u32 u32))
  (import \"i1\" (instance (export \"e1\" (func)) (export \"e3\" (func (param \"a\" u32)))))
  (import \"i2\" (func))
