...
impl<'a> TypeEncoder<'a> {
    ...
    fn flags(encodable: &mut Encodable, names: &wasmparser::collections::IndexSet<KebabString>) -> u32 {
        let index = encodable.type_count();
        encodable
            .ty()
            .defined_type()
    ...
    fn enum_type(encodable: &mut Encodable, cases: &wasmparser::collections::IndexSet<KebabString>) -> u32 {
        let index = encodable.type_count();
        encodable
            .ty()
            .defined_type()
