        ...
        let t = indices
            ...
            .map(move |l| {
                ...
                let iter: Box<dyn Iterator<Item = String>> = match lc {
                    ...
                    Lang::I32Add([left, right]) | Lang::I64Add([left, right]) | Lang::I32Sub([left, right]) | Lang::I64Sub([left, right]) | Lang::I32Mul([left, right]) | Lang::I64Mul([left, right]) | Lang::I32And([left, right]) | Lang::I64And([left, right]) | Lang::I32Or([left, right]) | Lang::I64Or([left, right]) | Lang::I32Xor([left, right]) | Lang::I64Xor([left, right]) | Lang::I32Shl([left, right]) | Lang::I64Shl([left, right]) | Lang::I32ShrU([left, right]) | Lang::I64ShrU([left, right]) | Lang::I32DivU([left, right]) | Lang::I64DivU([left, right]) | Lang::I32DivS([left, right]) | Lang::I64DivS([left, right]) | Lang::I32ShrS([left, right]) | Lang::I64ShrS([left, right]) | Lang::I32RotR([left, right]) | Lang::I64RotR([left, right]) | Lang::I32RotL([left, right]) | Lang::I64RotL([left, right]) | Lang::I32RemS([left, right]) | Lang::I64RemS([left, right]) | Lang::I32RemU([left, right]) | Lang::I64RemU([left, right]) | Lang::I32Eq([left, right]) | Lang::I64Eq([left, right]) | Lang::I32Ne([left, right]) | Lang::I64Ne([left, right]) | Lang::I32LtS([left, right]) | Lang::I64LtS([left, right]) | Lang::I32LtU([left, right]) | Lang::I64LtU([left, right]) | Lang::I32GtS([left, right]) | Lang::I64GtS([left, right]) | Lang::I32GtU([left, right]) | Lang::I64GtU([left, right]) | Lang::I32LeS([left, right]) | Lang::I64LeS([left, right]) | Lang::I32LeU([left, right]) | Lang::I64LeU([left, right]) | Lang::I32GeS([left, right]) | Lang::I64GeS([left, right]) | Lang::I32GeU([left, right]) | Lang::I64GeU([left, right]) | // binops floats
                    Lang::F32Add([left, right]) | Lang::F64Add([left, right]) | Lang::F32Sub([left, right]) | Lang::F64Sub([left, right]) | Lang::F32Mul([left, right]) | Lang::F64Mul([left, right]) | Lang::F32Div([left, right]) | Lang::F64Div([left, right]) | Lang::F32Min([left, right]) | Lang::F64Min([left, right]) | Lang::F32Max([left, right]) | Lang::F64Max([left, right]) | Lang::F32Copysign([left, right]) | Lang::F64Copysign([left, right])|
                    Lang::F32Eq([left, right]) | Lang::F64Eq([left, right]) | Lang::F32Ne([left, right]) | Lang::F64Ne([left, right]) | Lang::F32Lt([left, right]) | Lang::F64Lt([left, right]) | Lang::F32Gt([left, right]) | Lang::F64Gt([left, right]) | Lang::F32Le([left, right]) | Lang::F64Le([left, right]) | Lang::F32Ge([left, right]) | Lang::F64Ge([left, right]) 
                     => {
                    ...
                    Lang::Call(idx, arguments) => {
                        ...
                        for a in &arguments {
                            expr.push_str(&format!(" {}", lazy_expand(*a, eg.clone(), n, rnd).next().unwrap()));
                        }
                    ...
                    Lang::F32Abs([arg]) | Lang::F64Abs([arg]) | Lang::F32Neg([arg]) | Lang::F64Neg([arg]) | Lang::F32Sqrt([arg]) | Lang::F64Sqrt([arg]) | Lang::F32Ceil([arg]) | Lang::F64Ceil([arg]) | Lang::F32Floor([arg]) | Lang::F64Floor([arg]) | Lang::F32Trunc([arg]) | Lang::F64trunc([arg]) | Lang::F32Nearest([arg]) | Lang::F64Nearest([arg]) | Lang::Wrap([arg]) | Lang::I32Extend8S([arg]) | Lang::I64Extend8S([arg]) | Lang::I32Extend16S([arg]) | Lang::I64Extend16S([arg]) | Lang::I64Extend32S([arg]) | Lang::I64ExtendI32S([arg]) | Lang::I64ExtendI32U([arg]) | Lang::I32TruncF32S([arg]) | Lang::I32TruncF32U([arg]) | Lang::I32TruncF64S([arg]) | Lang::I32TruncF64U([arg]) | Lang::I64TruncF32S([arg]) | Lang::I64TruncF32U([arg]) | Lang::I64TruncF64S([arg]) | Lang::I64TruncF64U([arg]) | Lang::F32ConvertI32S([arg]) | Lang::F32ConvertI32U([arg]) | Lang::F32ConvertI64S([arg]) | Lang::F32ConvertI64U([arg]) | Lang::F32DemoteF64([arg]) | Lang::F64ConvertI32S([arg]) | Lang::F64ConvertI32U([arg]) | Lang::F64ConvertI64S([arg]) | Lang::F64ConvertI64U([arg]) | Lang::F64PromoteF32([arg]) | Lang::I32ReinterpretF32([arg]) | Lang::I64ReinterpretF64([arg]) | Lang::F32ReinterpretI32([arg]) | Lang::F64ReinterpretI64([arg]) | Lang::I32TruncSatF32S([arg]) | Lang::I32TruncSatF32U([arg]) | Lang::I32TruncSatF64S([arg]) | Lang::I32TruncSatF64U([arg]) | Lang::I64TruncSatF32S([arg]) | Lang::I64TruncSatF32U([arg]) | Lang::I64TruncSatF64S([arg]) | Lang::I64TruncSatF64U([arg]) |
                    Lang::Drop([arg]) |
                    Lang::I32Eqz([arg]) |
                    Lang::I64Eqz([arg]) |
                    Lang::I32Popcnt([arg]) |
                    ...
                    g @ Lang::GlobalGet(_) => Box::new(vec![g.display_op().to_string()].into_iter()),
