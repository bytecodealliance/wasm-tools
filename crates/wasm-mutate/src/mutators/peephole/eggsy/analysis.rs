...
impl PeepholeMutationAnalysis {
    ...
    pub fn get_returning_tpe(&self, l: &Lang) -> crate::Result<PrimitiveTypeInfo> {
        match l {
            ...
            Lang::F32Eq(_) => Ok(PrimitiveTypeInfo::F32),
            Lang::F64Eq(_) => Ok(PrimitiveTypeInfo::F64),
            Lang::F32Ne(_) => Ok(PrimitiveTypeInfo::F32),
            Lang::F64Ne(_) => Ok(PrimitiveTypeInfo::F64),
            Lang::F32Lt(_) => Ok(PrimitiveTypeInfo::F32),
            Lang::F64Lt(_) => Ok(PrimitiveTypeInfo::F64),
            Lang::F32Gt(_) => Ok(PrimitiveTypeInfo::F32),
            Lang::F64Gt(_) => Ok(PrimitiveTypeInfo::F64),
            Lang::F32Le(_) => Ok(PrimitiveTypeInfo::F32),
            Lang::F64Le(_) => Ok(PrimitiveTypeInfo::F64),
            Lang::F32Ge(_) => Ok(PrimitiveTypeInfo::F32),
            Lang::F64Ge(_) => Ok(PrimitiveTypeInfo::F64),
