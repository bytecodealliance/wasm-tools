...
instructions! {
    ...
    // Memory instructions.
    (Some(have_memory_and_offset), i32_load, MemoryNonFloat),
    (Some(have_memory_and_offset), i64_load, MemoryNonFloat),
    (Some(have_memory_and_offset), f32_load, Memory),
    (Some(have_memory_and_offset), f64_load, Memory),
    (Some(have_memory_and_offset), i32_load_8_s, MemoryNonFloat),
    (Some(have_memory_and_offset), i32_load_8_u, MemoryNonFloat),
    (Some(have_memory_and_offset), i32_load_16_s, MemoryNonFloat),
    (Some(have_memory_and_offset), i32_load_16_u, MemoryNonFloat),
    (Some(have_memory_and_offset), i64_load_8_s, MemoryNonFloat),
    (Some(have_memory_and_offset), i64_load_16_s, MemoryNonFloat),
    (Some(have_memory_and_offset), i64_load_32_s, MemoryNonFloat),
    (Some(have_memory_and_offset), i64_load_8_u, MemoryNonFloat),
    (Some(have_memory_and_offset), i64_load_16_u, MemoryNonFloat),
    (Some(have_memory_and_offset), i64_load_32_u, MemoryNonFloat),
    (Some(i32_store_valid), i32_store, MemoryNonFloat),
    (Some(i64_store_valid), i64_store, MemoryNonFloat),
    (Some(f32_store_valid), f32_store, Memory),
    (Some(f64_store_valid), f64_store, Memory),
    (Some(i32_store_valid), i32_store_8, MemoryNonFloat),
    (Some(i32_store_valid), i32_store_16, MemoryNonFloat),
    (Some(i64_store_valid), i64_store_8, MemoryNonFloat),
    (Some(i64_store_valid), i64_store_16, MemoryNonFloat),
    (Some(i64_store_valid), i64_store_32, MemoryNonFloat),
    (Some(have_memory), memory_size, MemoryNonFloat),
    (Some(memory_grow_valid), memory_grow, MemoryNonFloat),
    (Some(memory_init_valid), memory_init, MemoryNonFloat),
    (Some(data_drop_valid), data_drop, MemoryNonFloat),
    (Some(memory_copy_valid), memory_copy, MemoryNonFloat),
    (Some(memory_fill_valid), memory_fill, MemoryNonFloat),
    // Numeric instructions.
    (None, i32_const, NumericNonFloat),
    (None, i64_const, NumericNonFloat),
    (None, f32_const, Numeric),
    (None, f64_const, Numeric),
    (Some(i32_on_stack), i32_eqz, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_eq, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_ne, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_lt_s, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_lt_u, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_gt_s, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_gt_u, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_le_s, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_le_u, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_ge_s, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_ge_u, NumericNonFloat),
    (Some(i64_on_stack), i64_eqz, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_eq, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_ne, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_lt_s, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_lt_u, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_gt_s, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_gt_u, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_le_s, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_le_u, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_ge_s, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_ge_u, NumericNonFloat),
    ...
    (Some(i32_on_stack), i32_clz, NumericNonFloat),
    (Some(i32_on_stack), i32_ctz, NumericNonFloat),
    (Some(i32_on_stack), i32_popcnt, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_add, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_sub, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_mul, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_div_s, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_div_u, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_rem_s, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_rem_u, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_and, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_or, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_xor, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_shl, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_shr_s, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_shr_u, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_rotl, NumericNonFloat),
    (Some(i32_i32_on_stack), i32_rotr, NumericNonFloat),
    (Some(i64_on_stack), i64_clz, NumericNonFloat),
    (Some(i64_on_stack), i64_ctz, NumericNonFloat),
    (Some(i64_on_stack), i64_popcnt, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_add, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_sub, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_mul, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_div_s, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_div_u, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_rem_s, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_rem_u, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_and, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_or, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_xor, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_shl, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_shr_s, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_shr_u, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_rotl, NumericNonFloat),
    (Some(i64_i64_on_stack), i64_rotr, NumericNonFloat),
    ...
    (Some(i64_on_stack), i32_wrap_i64, NumericNonFloat),
    ...
    (Some(i32_on_stack), i64_extend_i32_s, NumericNonFloat),
    (Some(i32_on_stack), i64_extend_i32_u, NumericNonFloat),
    ...
    (Some(extendable_i32_on_stack), i32_extend_8_s, NumericNonFloat),
    (Some(extendable_i32_on_stack), i32_extend_16_s, NumericNonFloat),
    (Some(extendable_i64_on_stack), i64_extend_8_s, NumericNonFloat),
    (Some(extendable_i64_on_stack), i64_extend_16_s, NumericNonFloat),
    (Some(extendable_i64_on_stack), i64_extend_32_s, NumericNonFloat),
    ...
    // SIMD instructions.
    (Some(simd_have_memory_and_offset), v128_load, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load8x8s, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load8x8u, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load16x4s, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load16x4u, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load32x2s, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load32x2u, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load8_splat, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load16_splat, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load32_splat, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load64_splat, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load32_zero, VectorNonFloat),
    (Some(simd_have_memory_and_offset), v128_load64_zero, VectorNonFloat),
    (Some(simd_v128_store_valid), v128_store, VectorNonFloat),
    (Some(simd_load_lane_valid), v128_load8_lane, VectorNonFloat),
    (Some(simd_load_lane_valid), v128_load16_lane, VectorNonFloat),
    (Some(simd_load_lane_valid), v128_load32_lane, VectorNonFloat),
    (Some(simd_load_lane_valid), v128_load64_lane, VectorNonFloat),
    (Some(simd_store_lane_valid), v128_store8_lane, VectorNonFloat),
    (Some(simd_store_lane_valid), v128_store16_lane, VectorNonFloat),
    (Some(simd_store_lane_valid), v128_store32_lane, VectorNonFloat),
    (Some(simd_store_lane_valid), v128_store64_lane, VectorNonFloat),
    (Some(simd_enabled), v128_const, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_shuffle, VectorNonFloat),
    (Some(simd_v128_on_stack), i8x16_extract_lane_s, VectorNonFloat),
    (Some(simd_v128_on_stack), i8x16_extract_lane_u, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i8x16_replace_lane, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_extract_lane_s, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_extract_lane_u, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i16x8_replace_lane, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_extract_lane, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i32x4_replace_lane, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_extract_lane, VectorNonFloat),
    (Some(simd_v128_i64_on_stack), i64x2_replace_lane, VectorNonFloat),
    ...
    (Some(simd_i32_on_stack), i8x16_splat, VectorNonFloat),
    (Some(simd_i32_on_stack), i16x8_splat, VectorNonFloat),
    (Some(simd_i32_on_stack), i32x4_splat, VectorNonFloat),
    (Some(simd_i64_on_stack), i64x2_splat, VectorNonFloat),
    (Some(simd_f32_on_stack), f32x4_splat, Vector),
    (Some(simd_f64_on_stack), f64x2_splat, Vector),
    (Some(simd_v128_v128_on_stack), i8x16_swizzle, VectorNonFloat),
    (Some(simd_v128_v128_on_stack_relaxed), i8x16_relaxed_swizzle, VectorNonFloat),
    (Some(simd_v128_v128_v128_on_stack), v128_bitselect, VectorNonFloat),
    (Some(simd_v128_v128_v128_on_stack_relaxed), i8x16_relaxed_laneselect, VectorNonFloat),
    (Some(simd_v128_v128_v128_on_stack_relaxed), i16x8_relaxed_laneselect, VectorNonFloat),
    (Some(simd_v128_v128_v128_on_stack_relaxed), i32x4_relaxed_laneselect, VectorNonFloat),
    (Some(simd_v128_v128_v128_on_stack_relaxed), i64x2_relaxed_laneselect, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_eq, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_ne, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_lt_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_lt_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_gt_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_gt_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_le_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_le_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_ge_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_ge_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_eq, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_ne, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_lt_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_lt_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_gt_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_gt_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_le_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_le_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_ge_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_ge_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_eq, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_ne, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_lt_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_lt_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_gt_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_gt_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_le_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_le_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_ge_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_ge_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_eq, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_ne, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_lt_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_gt_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_le_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_ge_s, VectorNonFloat),
    ...
    (Some(simd_v128_on_stack), v128_not, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), v128_and, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), v128_and_not, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), v128_or, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), v128_xor, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), v128_any_true, VectorNonFloat),
    (Some(simd_v128_on_stack), i8x16_abs, VectorNonFloat),
    (Some(simd_v128_on_stack), i8x16_neg, VectorNonFloat),
    (Some(simd_v128_on_stack), i8x16_popcnt, VectorNonFloat),
    (Some(simd_v128_on_stack), i8x16_all_true, VectorNonFloat),
    (Some(simd_v128_on_stack), i8x16_bitmask, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_narrow_i16x8s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_narrow_i16x8u, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i8x16_shl, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i8x16_shr_s, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i8x16_shr_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_add, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_add_sat_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_add_sat_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_sub, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_sub_sat_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_sub_sat_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_min_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_min_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_max_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_max_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i8x16_avgr_u, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_extadd_pairwise_i8x16s, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_extadd_pairwise_i8x16u, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_abs, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_neg, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8q15_mulr_sat_s, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_all_true, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_bitmask, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_narrow_i32x4s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_narrow_i32x4u, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_extend_low_i8x16s, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_extend_high_i8x16s, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_extend_low_i8x16u, VectorNonFloat),
    (Some(simd_v128_on_stack), i16x8_extend_high_i8x16u, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i16x8_shl, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i16x8_shr_s, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i16x8_shr_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_add, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_add_sat_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_add_sat_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_sub, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_sub_sat_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_sub_sat_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_mul, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_min_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_min_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_max_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_max_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_avgr_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_extmul_low_i8x16s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_extmul_high_i8x16s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_extmul_low_i8x16u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i16x8_extmul_high_i8x16u, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_extadd_pairwise_i16x8s, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_extadd_pairwise_i16x8u, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_abs, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_neg, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_all_true, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_bitmask, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_extend_low_i16x8s, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_extend_high_i16x8s, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_extend_low_i16x8u, VectorNonFloat),
    (Some(simd_v128_on_stack), i32x4_extend_high_i16x8u, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i32x4_shl, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i32x4_shr_s, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i32x4_shr_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_add, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_sub, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_mul, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_min_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_min_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_max_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_max_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_dot_i16x8s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_extmul_low_i16x8s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_extmul_high_i16x8s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_extmul_low_i16x8u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i32x4_extmul_high_i16x8u, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_abs, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_neg, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_all_true, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_bitmask, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_extend_low_i32x4s, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_extend_high_i32x4s, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_extend_low_i32x4u, VectorNonFloat),
    (Some(simd_v128_on_stack), i64x2_extend_high_i32x4u, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i64x2_shl, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i64x2_shr_s, VectorNonFloat),
    (Some(simd_v128_i32_on_stack), i64x2_shr_u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_add, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_sub, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_mul, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_extmul_low_i32x4s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_extmul_high_i32x4s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_extmul_low_i32x4u, VectorNonFloat),
    (Some(simd_v128_v128_on_stack), i64x2_extmul_high_i32x4u, VectorNonFloat),
    ...
    (Some(simd_v128_v128_on_stack_relaxed), i16x8_relaxed_q15mulr_s, VectorNonFloat),
    (Some(simd_v128_v128_on_stack_relaxed), i16x8_relaxed_dot_i8x16_i7x16_s, VectorNonFloat),
    (Some(simd_v128_v128_v128_on_stack_relaxed), i32x4_relaxed_dot_i8x16_i7x16_add_s, VectorNonFloat),
}
