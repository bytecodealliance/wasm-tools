...
impl<'a> VisitOperator<'a> for Dump<'_> {
    ...
    dump! {
        ...
        fn visit_call_ref(&mut self, offset: usize)
        fn visit_return_call_ref(&mut self, offset: usize)
        ...
        fn visit_ref_null(&mut self, offset: usize, ty: HeapType)
        fn visit_ref_as_non_null(&mut self, offset: usize)
        fn visit_br_on_null(&mut self, offset: usize, relative_depth: u32)
        fn visit_br_on_non_null(&mut self, offset: usize, relative_depth: u32)
