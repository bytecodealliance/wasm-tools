...
pub enum Operator<'a> {
    ...
    V128Load8Lane { memarg: MemoryImmediate, lane: SIMDLaneIndex },
    V128Load16Lane { memarg: MemoryImmediate, lane: SIMDLaneIndex },
    V128Load32Lane { memarg: MemoryImmediate, lane: SIMDLaneIndex },
    V128Load64Lane { memarg: MemoryImmediate, lane: SIMDLaneIndex },
    V128Store8Lane { memarg: MemoryImmediate, lane: SIMDLaneIndex },
    V128Store16Lane { memarg: MemoryImmediate, lane: SIMDLaneIndex },
    V128Store32Lane { memarg: MemoryImmediate, lane: SIMDLaneIndex },
