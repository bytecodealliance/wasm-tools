...
macro_rules! for_each_operator {
    ($mac:ident) => {
        $mac! {
            ...
            @v128_simd V128Load { memarg: MemArg } => visit_v128_load
            @v128_simd V128Load8x8S { memarg: MemArg } => visit_v128_load8x8_s
            @v128_simd V128Load8x8U { memarg: MemArg } => visit_v128_load8x8_u
            @v128_simd V128Load16x4S { memarg: MemArg } => visit_v128_load16x4_s
            @v128_simd V128Load16x4U { memarg: MemArg } => visit_v128_load16x4_u
            @v128_simd V128Load32x2S { memarg: MemArg } => visit_v128_load32x2_s
            @v128_simd V128Load32x2U { memarg: MemArg } => visit_v128_load32x2_u
            @v128_simd V128Load8Splat { memarg: MemArg } => visit_v128_load8_splat
            @v128_simd V128Load16Splat { memarg: MemArg } => visit_v128_load16_splat
            @v128_simd V128Load32Splat { memarg: MemArg } => visit_v128_load32_splat
            @v128_simd V128Load64Splat { memarg: MemArg } => visit_v128_load64_splat
            @v128_simd V128Load32Zero { memarg: MemArg } => visit_v128_load32_zero
            @v128_simd V128Load64Zero { memarg: MemArg } => visit_v128_load64_zero
            @v128_simd V128Store { memarg: MemArg } => visit_v128_store
            @v128_simd V128Load8Lane { memarg: MemArg, lane: u8 } => visit_v128_load8_lane
            @v128_simd V128Load16Lane { memarg: MemArg, lane: u8 } => visit_v128_load16_lane
            @v128_simd V128Load32Lane { memarg: MemArg, lane: u8 } => visit_v128_load32_lane
            @v128_simd V128Load64Lane { memarg: MemArg, lane: u8 } => visit_v128_load64_lane
            @v128_simd V128Store8Lane { memarg: MemArg, lane: u8 } => visit_v128_store8_lane
            @v128_simd V128Store16Lane { memarg: MemArg, lane: u8 } => visit_v128_store16_lane
            @v128_simd V128Store32Lane { memarg: MemArg, lane: u8 } => visit_v128_store32_lane
            @v128_simd V128Store64Lane { memarg: MemArg, lane: u8 } => visit_v128_store64_lane
            @v128_simd V128Const { value: V128 } => visit_v128_const
            @v128_simd I8x16Shuffle { lanes: [u8; 16] } => visit_i8x16_shuffle
            @v128_simd I8x16ExtractLaneS { lane: u8 } => visit_i8x16_extract_lane_s
            @v128_simd I8x16ExtractLaneU { lane: u8 } => visit_i8x16_extract_lane_u
            @v128_simd I8x16ReplaceLane { lane: u8 } => visit_i8x16_replace_lane
            @v128_simd I16x8ExtractLaneS { lane: u8 } => visit_i16x8_extract_lane_s
            @v128_simd I16x8ExtractLaneU { lane: u8 } => visit_i16x8_extract_lane_u
            @v128_simd I16x8ReplaceLane { lane: u8 } => visit_i16x8_replace_lane
            @v128_simd I32x4ExtractLane { lane: u8 } => visit_i32x4_extract_lane
            @v128_simd I32x4ReplaceLane { lane: u8 } => visit_i32x4_replace_lane
            @v128_simd I64x2ExtractLane { lane: u8 } => visit_i64x2_extract_lane
            @v128_simd I64x2ReplaceLane { lane: u8 } => visit_i64x2_replace_lane
            @v128_simd F32x4ExtractLane { lane: u8 } => visit_f32x4_extract_lane
            @v128_simd F32x4ReplaceLane { lane: u8 } => visit_f32x4_replace_lane
            @v128_simd F64x2ExtractLane { lane: u8 } => visit_f64x2_extract_lane
            @v128_simd F64x2ReplaceLane { lane: u8 } => visit_f64x2_replace_lane
            @v128_simd I8x16Swizzle => visit_i8x16_swizzle
            @v128_simd I8x16Splat => visit_i8x16_splat
            @v128_simd I16x8Splat => visit_i16x8_splat
            @v128_simd I32x4Splat => visit_i32x4_splat
            @v128_simd I64x2Splat => visit_i64x2_splat
            @v128_simd F32x4Splat => visit_f32x4_splat
            @v128_simd F64x2Splat => visit_f64x2_splat
            @v128_simd I8x16Eq => visit_i8x16_eq
            @v128_simd I8x16Ne => visit_i8x16_ne
            @v128_simd I8x16LtS => visit_i8x16_lt_s
            @v128_simd I8x16LtU => visit_i8x16_lt_u
            @v128_simd I8x16GtS => visit_i8x16_gt_s
            @v128_simd I8x16GtU => visit_i8x16_gt_u
            @v128_simd I8x16LeS => visit_i8x16_le_s
            @v128_simd I8x16LeU => visit_i8x16_le_u
            @v128_simd I8x16GeS => visit_i8x16_ge_s
            @v128_simd I8x16GeU => visit_i8x16_ge_u
            @v128_simd I16x8Eq => visit_i16x8_eq
            @v128_simd I16x8Ne => visit_i16x8_ne
            @v128_simd I16x8LtS => visit_i16x8_lt_s
            @v128_simd I16x8LtU => visit_i16x8_lt_u
            @v128_simd I16x8GtS => visit_i16x8_gt_s
            @v128_simd I16x8GtU => visit_i16x8_gt_u
            @v128_simd I16x8LeS => visit_i16x8_le_s
            @v128_simd I16x8LeU => visit_i16x8_le_u
            @v128_simd I16x8GeS => visit_i16x8_ge_s
            @v128_simd I16x8GeU => visit_i16x8_ge_u
            @v128_simd I32x4Eq => visit_i32x4_eq
            @v128_simd I32x4Ne => visit_i32x4_ne
            @v128_simd I32x4LtS => visit_i32x4_lt_s
            @v128_simd I32x4LtU => visit_i32x4_lt_u
            @v128_simd I32x4GtS => visit_i32x4_gt_s
            @v128_simd I32x4GtU => visit_i32x4_gt_u
            @v128_simd I32x4LeS => visit_i32x4_le_s
            @v128_simd I32x4LeU => visit_i32x4_le_u
            @v128_simd I32x4GeS => visit_i32x4_ge_s
            @v128_simd I32x4GeU => visit_i32x4_ge_u
            @v128_simd I64x2Eq => visit_i64x2_eq
            @v128_simd I64x2Ne => visit_i64x2_ne
            @v128_simd I64x2LtS => visit_i64x2_lt_s
            @v128_simd I64x2GtS => visit_i64x2_gt_s
            @v128_simd I64x2LeS => visit_i64x2_le_s
            @v128_simd I64x2GeS => visit_i64x2_ge_s
            @v128_simd F32x4Eq => visit_f32x4_eq
            @v128_simd F32x4Ne => visit_f32x4_ne
            @v128_simd F32x4Lt => visit_f32x4_lt
            @v128_simd F32x4Gt => visit_f32x4_gt
            @v128_simd F32x4Le => visit_f32x4_le
            @v128_simd F32x4Ge => visit_f32x4_ge
            @v128_simd F64x2Eq => visit_f64x2_eq
            @v128_simd F64x2Ne => visit_f64x2_ne
            @v128_simd F64x2Lt => visit_f64x2_lt
            @v128_simd F64x2Gt => visit_f64x2_gt
            @v128_simd F64x2Le => visit_f64x2_le
            @v128_simd F64x2Ge => visit_f64x2_ge
            @v128_simd V128Not => visit_v128_not
            @v128_simd V128And => visit_v128_and
            @v128_simd V128AndNot => visit_v128_andnot
            @v128_simd V128Or => visit_v128_or
            @v128_simd V128Xor => visit_v128_xor
            @v128_simd V128Bitselect => visit_v128_bitselect
            @v128_simd V128AnyTrue => visit_v128_any_true
            @v128_simd I8x16Abs => visit_i8x16_abs
            @v128_simd I8x16Neg => visit_i8x16_neg
            @v128_simd I8x16Popcnt => visit_i8x16_popcnt
            @v128_simd I8x16AllTrue => visit_i8x16_all_true
            @v128_simd I8x16Bitmask => visit_i8x16_bitmask
            @v128_simd I8x16NarrowI16x8S => visit_i8x16_narrow_i16x8_s
            @v128_simd I8x16NarrowI16x8U => visit_i8x16_narrow_i16x8_u
            @v128_simd I8x16Shl => visit_i8x16_shl
            @v128_simd I8x16ShrS => visit_i8x16_shr_s
            @v128_simd I8x16ShrU => visit_i8x16_shr_u
            @v128_simd I8x16Add => visit_i8x16_add
            @v128_simd I8x16AddSatS => visit_i8x16_add_sat_s
            @v128_simd I8x16AddSatU => visit_i8x16_add_sat_u
            @v128_simd I8x16Sub => visit_i8x16_sub
            @v128_simd I8x16SubSatS => visit_i8x16_sub_sat_s
            @v128_simd I8x16SubSatU => visit_i8x16_sub_sat_u
            @v128_simd I8x16MinS => visit_i8x16_min_s
            @v128_simd I8x16MinU => visit_i8x16_min_u
            @v128_simd I8x16MaxS => visit_i8x16_max_s
            @v128_simd I8x16MaxU => visit_i8x16_max_u
            @v128_simd I8x16RoundingAverageU => visit_i8x16_avgr_u
            @v128_simd I16x8ExtAddPairwiseI8x16S => visit_i16x8_extadd_pairwise_i8x16_s
            @v128_simd I16x8ExtAddPairwiseI8x16U => visit_i16x8_extadd_pairwise_i8x16_u
            @v128_simd I16x8Abs => visit_i16x8_abs
            @v128_simd I16x8Neg => visit_i16x8_neg
            @v128_simd I16x8Q15MulrSatS => visit_i16x8_q15mulr_sat_s
            @v128_simd I16x8AllTrue => visit_i16x8_all_true
            @v128_simd I16x8Bitmask => visit_i16x8_bitmask
            @v128_simd I16x8NarrowI32x4S => visit_i16x8_narrow_i32x4_s
            @v128_simd I16x8NarrowI32x4U => visit_i16x8_narrow_i32x4_u
            @v128_simd I16x8ExtendLowI8x16S => visit_i16x8_extend_low_i8x16_s
            @v128_simd I16x8ExtendHighI8x16S => visit_i16x8_extend_high_i8x16_s
            @v128_simd I16x8ExtendLowI8x16U => visit_i16x8_extend_low_i8x16_u
            @v128_simd I16x8ExtendHighI8x16U => visit_i16x8_extend_high_i8x16_u
            @v128_simd I16x8Shl => visit_i16x8_shl
            @v128_simd I16x8ShrS => visit_i16x8_shr_s
            @v128_simd I16x8ShrU => visit_i16x8_shr_u
            @v128_simd I16x8Add => visit_i16x8_add
            @v128_simd I16x8AddSatS => visit_i16x8_add_sat_s
            @v128_simd I16x8AddSatU => visit_i16x8_add_sat_u
            @v128_simd I16x8Sub => visit_i16x8_sub
            @v128_simd I16x8SubSatS => visit_i16x8_sub_sat_s
            @v128_simd I16x8SubSatU => visit_i16x8_sub_sat_u
            @v128_simd I16x8Mul => visit_i16x8_mul
            @v128_simd I16x8MinS => visit_i16x8_min_s
            @v128_simd I16x8MinU => visit_i16x8_min_u
            @v128_simd I16x8MaxS => visit_i16x8_max_s
            @v128_simd I16x8MaxU => visit_i16x8_max_u
            @v128_simd I16x8RoundingAverageU => visit_i16x8_avgr_u
            @v128_simd I16x8ExtMulLowI8x16S => visit_i16x8_extmul_low_i8x16_s
            @v128_simd I16x8ExtMulHighI8x16S => visit_i16x8_extmul_high_i8x16_s
            @v128_simd I16x8ExtMulLowI8x16U => visit_i16x8_extmul_low_i8x16_u
            @v128_simd I16x8ExtMulHighI8x16U => visit_i16x8_extmul_high_i8x16_u
            @v128_simd I32x4ExtAddPairwiseI16x8S => visit_i32x4_extadd_pairwise_i16x8_s
            @v128_simd I32x4ExtAddPairwiseI16x8U => visit_i32x4_extadd_pairwise_i16x8_u
            @v128_simd I32x4Abs => visit_i32x4_abs
            @v128_simd I32x4Neg => visit_i32x4_neg
            @v128_simd I32x4AllTrue => visit_i32x4_all_true
            @v128_simd I32x4Bitmask => visit_i32x4_bitmask
            @v128_simd I32x4ExtendLowI16x8S => visit_i32x4_extend_low_i16x8_s
            @v128_simd I32x4ExtendHighI16x8S => visit_i32x4_extend_high_i16x8_s
            @v128_simd I32x4ExtendLowI16x8U => visit_i32x4_extend_low_i16x8_u
            @v128_simd I32x4ExtendHighI16x8U => visit_i32x4_extend_high_i16x8_u
            @v128_simd I32x4Shl => visit_i32x4_shl
            @v128_simd I32x4ShrS => visit_i32x4_shr_s
            @v128_simd I32x4ShrU => visit_i32x4_shr_u
            @v128_simd I32x4Add => visit_i32x4_add
            @v128_simd I32x4Sub => visit_i32x4_sub
            @v128_simd I32x4Mul => visit_i32x4_mul
            @v128_simd I32x4MinS => visit_i32x4_min_s
            @v128_simd I32x4MinU => visit_i32x4_min_u
            @v128_simd I32x4MaxS => visit_i32x4_max_s
            @v128_simd I32x4MaxU => visit_i32x4_max_u
            @v128_simd I32x4DotI16x8S => visit_i32x4_dot_i16x8_s
            @v128_simd I32x4ExtMulLowI16x8S => visit_i32x4_extmul_low_i16x8_s
            @v128_simd I32x4ExtMulHighI16x8S => visit_i32x4_extmul_high_i16x8_s
            @v128_simd I32x4ExtMulLowI16x8U => visit_i32x4_extmul_low_i16x8_u
            @v128_simd I32x4ExtMulHighI16x8U => visit_i32x4_extmul_high_i16x8_u
            @v128_simd I64x2Abs => visit_i64x2_abs
            @v128_simd I64x2Neg => visit_i64x2_neg
            @v128_simd I64x2AllTrue => visit_i64x2_all_true
            @v128_simd I64x2Bitmask => visit_i64x2_bitmask
            @v128_simd I64x2ExtendLowI32x4S => visit_i64x2_extend_low_i32x4_s
            @v128_simd I64x2ExtendHighI32x4S => visit_i64x2_extend_high_i32x4_s
            @v128_simd I64x2ExtendLowI32x4U => visit_i64x2_extend_low_i32x4_u
            @v128_simd I64x2ExtendHighI32x4U => visit_i64x2_extend_high_i32x4_u
            @v128_simd I64x2Shl => visit_i64x2_shl
            @v128_simd I64x2ShrS => visit_i64x2_shr_s
            @v128_simd I64x2ShrU => visit_i64x2_shr_u
            @v128_simd I64x2Add => visit_i64x2_add
            @v128_simd I64x2Sub => visit_i64x2_sub
            @v128_simd I64x2Mul => visit_i64x2_mul
            @v128_simd I64x2ExtMulLowI32x4S => visit_i64x2_extmul_low_i32x4_s
            @v128_simd I64x2ExtMulHighI32x4S => visit_i64x2_extmul_high_i32x4_s
            @v128_simd I64x2ExtMulLowI32x4U => visit_i64x2_extmul_low_i32x4_u
            @v128_simd I64x2ExtMulHighI32x4U => visit_i64x2_extmul_high_i32x4_u
            @v128_simd F32x4Ceil => visit_f32x4_ceil
            @v128_simd F32x4Floor => visit_f32x4_floor
            @v128_simd F32x4Trunc => visit_f32x4_trunc
            @v128_simd F32x4Nearest => visit_f32x4_nearest
            @v128_simd F32x4Abs => visit_f32x4_abs
            @v128_simd F32x4Neg => visit_f32x4_neg
            @v128_simd F32x4Sqrt => visit_f32x4_sqrt
            @v128_simd F32x4Add => visit_f32x4_add
            @v128_simd F32x4Sub => visit_f32x4_sub
            @v128_simd F32x4Mul => visit_f32x4_mul
            @v128_simd F32x4Div => visit_f32x4_div
            @v128_simd F32x4Min => visit_f32x4_min
            @v128_simd F32x4Max => visit_f32x4_max
            @v128_simd F32x4PMin => visit_f32x4_pmin
            @v128_simd F32x4PMax => visit_f32x4_pmax
            @v128_simd F64x2Ceil => visit_f64x2_ceil
            @v128_simd F64x2Floor => visit_f64x2_floor
            @v128_simd F64x2Trunc => visit_f64x2_trunc
            @v128_simd F64x2Nearest => visit_f64x2_nearest
            @v128_simd F64x2Abs => visit_f64x2_abs
            @v128_simd F64x2Neg => visit_f64x2_neg
            @v128_simd F64x2Sqrt => visit_f64x2_sqrt
            @v128_simd F64x2Add => visit_f64x2_add
            @v128_simd F64x2Sub => visit_f64x2_sub
            @v128_simd F64x2Mul => visit_f64x2_mul
            @v128_simd F64x2Div => visit_f64x2_div
            @v128_simd F64x2Min => visit_f64x2_min
            @v128_simd F64x2Max => visit_f64x2_max
            @v128_simd F64x2PMin => visit_f64x2_pmin
            @v128_simd F64x2PMax => visit_f64x2_pmax
            @v128_simd I32x4TruncSatF32x4S => visit_i32x4_trunc_sat_f32x4_s
            @v128_simd I32x4TruncSatF32x4U => visit_i32x4_trunc_sat_f32x4_u
            @v128_simd F32x4ConvertI32x4S => visit_f32x4_convert_i32x4_s
            @v128_simd F32x4ConvertI32x4U => visit_f32x4_convert_i32x4_u
            @v128_simd I32x4TruncSatF64x2SZero => visit_i32x4_trunc_sat_f64x2_s_zero
            @v128_simd I32x4TruncSatF64x2UZero => visit_i32x4_trunc_sat_f64x2_u_zero
            @v128_simd F64x2ConvertLowI32x4S => visit_f64x2_convert_low_i32x4_s
            @v128_simd F64x2ConvertLowI32x4U => visit_f64x2_convert_low_i32x4_u
            @v128_simd F32x4DemoteF64x2Zero => visit_f32x4_demote_f64x2_zero
            @v128_simd F64x2PromoteLowF32x4 => visit_f64x2_promote_low_f32x4
