...
pub const MAX_WASM_IMPORTS: usize = 1_000;
pub const MAX_WASM_EXPORTS: usize = 1_000;
pub const MAX_WASM_GLOBALS: usize = 4_000;
pub const MAX_WASM_DATA_SEGMENTS: usize = 10_000;
pub const MAX_WASM_MEMORY_PAGES: usize = 1_000;
pub const MAX_WASM_STRING_SIZE: usize = 100_000;
pub const _MAX_WASM_MODULE_SIZE: usize = 1024 * 1024 * 32; //= 32 MiB
...
pub const MAX_WASM_MEMORY64_PAGES: u64 = MAX_WASM_MEMORY_PAGES as u64;
