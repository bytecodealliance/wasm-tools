    ...
    T: WasmModuleResources,
{
    ...
    fn visit_call_ref(&mut self, offset: usize) -> Self::Output { forward!(self.visit_call_ref(offset)) }
    fn visit_return_call_ref(&mut self, offset: usize) -> Self::Output { forward!(self.visit_return_call_ref(offset)) }
    ...
    fn visit_ref_null(&mut self, offset: usize, ty: HeapType) -> Self::Output { forward!(self.visit_ref_null(offset, ty)) }
    fn visit_ref_as_non_null(&mut self, offset: usize) -> Self::Output { forward!(self.visit_ref_as_non_null(offset)) }
    fn visit_br_on_null(&mut self, offset: usize, relative_depth: u32) -> Self::Output { forward!(self.visit_br_on_null(offset, relative_depth)) }
    fn visit_br_on_non_null(&mut self, offset: usize, relative_depth: u32) -> Self::Output { forward!(self.visit_br_on_non_null(offset, relative_depth)) }
