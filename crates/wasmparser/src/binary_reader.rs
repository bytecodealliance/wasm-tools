...
impl<'a> BinaryReader<'a> {
    ...
    fn read_0xfd_operator(&mut self) -> Result<Operator<'a>> {
        ...
        Ok(match code {
            ...
            0x7e => Operator::I32x4ExtAddPairwise16x8S,
            0x7f => Operator::I32x4ExtAddPairwise16x8U,
            ...
            0xfc => Operator::F64x2ConvertLowI32x4S,
            0xfd => Operator::F64x2ConvertLowI32x4U,
            0xfe => Operator::I32x4TruncSatF64x2SZero,
            0xff => Operator::I32x4TruncSatF64x2UZero,
