...
impl<'a> BinaryReader<'a> {
        ...
        T: VisitOperator<'a>,
    {
        ...
        Ok(match code {
            ...
            0xaf => visitor.visit_f32x4_relaxed_fma(pos),
            0xb0 => visitor.visit_f32x4_relaxed_fnma(pos),
            0xb1 => visitor.visit_i32x4_sub(pos),
            0xb2 => visitor.visit_i8x16_relaxed_laneselect(pos),
            0xb3 => visitor.visit_i16x8_relaxed_laneselect(pos),
            ...
            0xcf => visitor.visit_f64x2_relaxed_fma(pos),
            0xd0 => visitor.visit_f64x2_relaxed_fnma(pos),
            0xd1 => visitor.visit_i64x2_sub(pos),
            0xd2 => visitor.visit_i32x4_relaxed_laneselect(pos),
            0xd3 => visitor.visit_i64x2_relaxed_laneselect(pos),
