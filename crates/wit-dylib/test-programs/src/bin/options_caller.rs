...
impl TestCase for MyInterpreter {
    fn call_export(wit: Wit, func: Function, args: OwnVals<'_, Self>) -> Option<Box<Val>> {
        ...
        assert_eq!(ret, Some(Box::new(Val::Option(None))));
        ...
        assert_eq!(
            ret,
            Some(Box::new(Val::Option(Some(Box::new(Val::U32(100))))))
        );
        ...
        assert_eq!(
            ret,
            Some(Box::new(Val::Option(Some(Box::new(Val::U64(800))))))
        );
        ...
        assert_eq!(
            ret,
            Some(Box::new(Val::Option(Some(Box::new(Val::F32(212.))))))
        );
        ...
        assert_eq!(
            ret,
            Some(Box::new(Val::Option(Some(Box::new(Val::F64(200.))))))
        );
        ...
        assert_eq!(
            ret,
            Some(Box::new(Val::Option(Some(Box::new(Val::String(
                "hello".to_string()
            ))))))
        );
