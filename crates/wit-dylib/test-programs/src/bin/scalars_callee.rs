    ...
    fn call_export(_wit: Wit, func: Function, mut args: OwnVals<'_, Self>) -> Option<Box<Val>> {
        ...
        match func.name() {
            "add-u8" => {
                ...
                Some(Box::new(Val::U8(a.wrapping_add(b))))
            }
            "add-s8" => {
                assert_eq!(func.params().len(), 2);
                assert!(func.result().is_some());
                ...
                Some(Box::new(Val::S8(a.wrapping_add(b))))
            }
            "add-u16" => {
                assert_eq!(func.params().len(), 2);
                assert!(func.result().is_some());
                ...
                Some(Box::new(Val::U16(a.wrapping_add(b))))
            }
            "add-s16" => {
                assert_eq!(func.params().len(), 2);
                assert!(func.result().is_some());
                ...
                Some(Box::new(Val::S16(a.wrapping_add(b))))
            }
            "add-u32" => {
                assert_eq!(func.params().len(), 2);
                assert!(func.result().is_some());
                ...
                Some(Box::new(Val::U32(a.wrapping_add(b))))
            }
            "add-s32" => {
                assert_eq!(func.params().len(), 2);
                assert!(func.result().is_some());
                ...
                Some(Box::new(Val::S32(a.wrapping_add(b))))
            }
            "add-u64" => {
                assert_eq!(func.params().len(), 2);
                assert!(func.result().is_some());
                ...
                Some(Box::new(Val::U64(a.wrapping_add(b))))
            }
            "add-s64" => {
                assert_eq!(func.params().len(), 2);
                assert!(func.result().is_some());
                ...
                Some(Box::new(Val::S64(a.wrapping_add(b))))
            }
            "add-f32" => {
                assert_eq!(func.params().len(), 2);
                assert!(func.result().is_some());
