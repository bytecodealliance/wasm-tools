...
(module
  ...
  (module $B
    ...
    (instance $a (instantiate $A "wasi" (instance $wasi)))
    (func (export "b"))
  )
  (module $B_wrap
    (type $Wasi (instance))
  ...
  (module $C
    ...
    (instance $b (instantiate $B "wasi" (instance $wasi)))
    (func (export "c"))
  )
  (module $C_wrap
    (type $Wasi (instance))
  ...
  (module $D
    ...
    (instance $c (instantiate $C "wasi" (instance $wasi)))
    (func (export "d"))
  )
