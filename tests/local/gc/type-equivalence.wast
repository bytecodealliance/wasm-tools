;; Cloned from tests/testsuite/proposals/function-references/type-equivalence.wast
;; and modified for the GC proposal.
...
;; This case has been made valid by the GC proposal:
;; every standalone type is now a recursive type group of size 1.
(module
