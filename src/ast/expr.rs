...
instructions! {
    pub enum Instruction<'a> {
        ...
        Drop : [0x1a] : "drop",
        Select : [0x1b] : "select",
        LocalSet(ast::Index<'a>) : [0x20] : "local.set" | "set_local",
        LocalGet(ast::Index<'a>) : [0x21] : "local.get" | "get_local",
        LocalTee(ast::Index<'a>) : [0x22] : "local.tee" | "tee_local",
        GlobalSet(ast::Index<'a>) : [0x23] : "global.set" | "set_global",
        GlobalGet(ast::Index<'a>) : [0x24] : "global.get" | "get_global",
